...
(lib.bg = function() {
	this.initialize(img._410_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1252,1400);


(lib.bg_blur = function() {
	this.initialize(img._410_2_bg_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1252,1400);


(lib.ch_base = function() {
	this.initialize(img._410_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1252,1400);


(lib.ch_face2 = function() {
	this.initialize(img._410_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.ch_face3 = function() {
	this.initialize(img._410_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.ch_face4 = function() {
	this.initialize(img._410_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.ch_face5 = function() {
	this.initialize(img._410_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.ch_face6 = function() {
	this.initialize(img._410_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.ch_face7 = function() {
	this.initialize(img._410_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.ch_face8 = function() {
	this.initialize(img._410_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,284);


(lib.finish = function() {
	this.initialize(img._410_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._410_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._410_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._410_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,128,142), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,626,700), null);
...
(lib.bg_zoom_half_blur = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(0,0,626,700);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(48.025,0.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AhFAJIAAgRICLAAIAAARg");
	this.shape_1.setTransform(32,0.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AhLA6QAMgJAHgMQAIgLAEgOQADgMABgOQACgOAAgOIAAgMIAAgMIASAAIAAALQAAAdgDAWQgDAVgIASQgIASgQAPgAAAAgIAAggIAAhDIARAAIAAAMIAAARIAAAVIgBAVIAAAVIAAAPQAMgFAIgKQAJgJAHgMQAGgLAFgMIANAPQgEAJgIAMQgHALgJAKQgKAKgMAIQgMAHgOADIAAgig");
	this.shape_2.setTransform(16.15,0.525);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AhEAJIAAgRICJAAIAAARg");
	this.shape_3.setTransform(0,0.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(-15.725,0.125);
	...
	this.shape_5.setTransform(-31.8227,0.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(-47.85,-0.125);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_8 = new cjs.Graphics().p("AinBzQglgLgagLQhigpA5gqIApggIBlhSQBFg3AxAAQBPAADcAUQAKCzgKAAQgPAegeAeQg8A8hLAAQh6AAiZgtg");
	var mask_graphics_9 = new cjs.Graphics().p("AinBzQglgLgagLQhigpA5gqIApggIBlhSQBFg3AxAAQBPAADcAUQAKCzgKAAQgPAegeAeQg8A8hLAAQh6AAiZgtg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(8).to({graphics:mask_graphics_8,x:64.1842,y:107}).wait(1).to({graphics:mask_graphics_9,x:64.1842,y:107}).wait(1).to({graphics:null,x:0,y:0}).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(8).to({_off:false},0).wait(1).to({_off:true},1).wait(10));

	// mask_face (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("ArPLQIAA2fIWfAAIAAWfg");
	mask_1.setTransform(73,73);
	...
	var maskedShapeInstanceList = [this.instance_3,this.instance_4,this.instance_5,this.instance_6,this.instance_7,this.instance_8,this.instance_9];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask_1;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).wait(10));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-102,221);
...
(lib.bg_zoom_half = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{bg_gitter_wait:0,bg_gitter_start:2,bg_gitter_stop:16});
	...
	this.frame_27 = function() {
		this.gotoAndStop("bg_wait");
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(13).call(this.frame_15).wait(1).call(this.frame_16).wait(11).call(this.frame_27).wait(1));

	// gitter
	this.instance = new lib.glitter_first();
	this.instance.parent = this;
	this.instance.setTransform(536.1,480.05,0.0766,0.0766);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).wait(14).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_1 = new lib.glitter_first();
	this.instance_1.parent = this;
	this.instance_1.setTransform(495.4,313.5,0.0664,0.0664);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).wait(13).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_2 = new lib.glitter_first();
	this.instance_2.parent = this;
	this.instance_2.setTransform(527.3,440.85,0.0799,0.0799);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).wait(12).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_3 = new lib.glitter_first();
	this.instance_3.parent = this;
	this.instance_3.setTransform(484.8,340.2,0.0623,0.0623,0,0,0,-0.8,3.2);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(5).to({_off:false},0).wait(11).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_4 = new lib.glitter_first();
	this.instance_4.parent = this;
	this.instance_4.setTransform(408.75,392.05,0.0849,0.0849);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).wait(10).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_5 = new lib.glitter_first();
	this.instance_5.parent = this;
	this.instance_5.setTransform(519.15,378,0.0596,0.0596);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(8).to({_off:false},0).wait(8).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_6 = new lib.glitter_first();
	this.instance_6.parent = this;
	this.instance_6.setTransform(421.5,438.85,0.0646,0.0646);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).wait(7).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_7 = new lib.glitter_first();
	this.instance_7.parent = this;
	this.instance_7.setTransform(511.45,406.3,0.0938,0.0938);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(10).to({_off:false},0).wait(6).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_8 = new lib.glitter_first();
	this.instance_8.parent = this;
	this.instance_8.setTransform(416.35,361.85,0.0648,0.0648);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(11).to({_off:false},0).wait(5).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_9 = new lib.glitter_first();
	this.instance_9.parent = this;
	this.instance_9.setTransform(465.75,311.2,0.0801,0.0801);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(12).to({_off:false},0).wait(4).to({alpha:0},9).to({_off:true},1).wait(2));

	// gitter
	this.instance_10 = new lib.glitter_first();
	this.instance_10.parent = this;
	this.instance_10.setTransform(441.1,331.1,0.0525,0.0525);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(13).to({_off:false},0).wait(3).to({alpha:0},9).to({_off:true},1).wait(2));
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.glitter_first();
	this.instance_2.parent = this;
	this.instance_2.setTransform(83.2,255.3,0.1412,0.1412);
	this.instance_2._off = true;
	...
	this.instance_4 = new lib.glitter_first();
	this.instance_4.parent = this;
	this.instance_4.setTransform(188.65,55.5,0.0849,0.0849);
	this.instance_4._off = true;
	...
	this.instance_5 = new lib.glitter_first();
	this.instance_5.parent = this;
	this.instance_5.setTransform(225.05,176.15,0.1618,0.1618);
	this.instance_5._off = true;
	...
	this.instance_6 = new lib.glitter_first();
	this.instance_6.parent = this;
	this.instance_6.setTransform(218.55,32.3,0.1362,0.1362);
	this.instance_6._off = true;
	...
	this.instance_9 = new lib.glitter_first();
	this.instance_9.parent = this;
	this.instance_9.setTransform(19.4,69.05,0.2555,0.2555);
	this.instance_9._off = true;
	...
	this.instance_10 = new lib.glitter_first();
	this.instance_10.parent = this;
	this.instance_10.setTransform(174.7,252.45,0.1176,0.1176);
	this.instance_10._off = true;
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 0, 1, 1, 0, 0, 1, 0, 1, 1, 1, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AmgECIhTgJIhKgSIgqhUIgChEQgBhDABABIA8hLIB9hiIBhgeIA2gJIBFAGIAnAdIAsAWIBNAVICFAMIBPAAIA3gxIAhg+IAqgeIAygKIA9AIIBDAcIBcA5IAoAoIAQBKIACBQIgOBPIg5AbIhRAXIhkATIhmAAIhogOQgPgCgnAAIh3AAIiWAeIgsAUIgzAjIg6ARg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:63.655,y:49}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:64,regY:71,x:64,y:71,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:64,regY:71,x:64,y:71,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
...
p.nominalBounds = new cjs.Rectangle(-222,-175,626,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-127,-146);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-247,-542,626,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(20).call(this.frame_462).wait(1).call(this.frame_463).wait(19).call(this.frame_482).wait(1).call(this.frame_483).wait(14).call(this.frame_497).wait(1));

	// effect_look_to_right2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(109.9,-392.3,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:135.5,y:-401.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:147.15,y:-405.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:109.9,y:-392.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:135.5,y:-401.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:147.15,y:-405.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:109.9,y:-392.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:135.5,y:-401.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:147.15,y:-405.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:109.9,y:-392.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:135.5,y:-401.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:147.15,y:-405.6,alpha:0.2188},0).to({_off:true},1).wait(166));

	// effect_look_to_right
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(40,-320,1.4807,1.4807,0,0,180);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(40,-320,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(141.95,-414.25,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(157.95,-410.7,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(99.4,-330.95,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(118.6,-386.5,1.053,1.053,7.4788,0,0,0.1,-0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(120.7,-413.4,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(106.5,-382.7,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(111.7,-382.55,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(134.65,-405.35,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(72.1,-243.95,1,1,0,0,180);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(106.35,-371.4,0.4532,0.4532,0,0,180);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(91.3,-368.35,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-12.75,-412.1,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(44.95,-324.45,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[{t:this.instance_4}]},9).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).wait(15));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-414.3},0).wait(3).to({regX:-28.8,x:141.55,y:-414.15,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:141.95,y:-414.3,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-414.25,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-414.3},0).wait(3).to({regX:-28.8,x:141.55,y:-414.15,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:141.95,y:-414.3,alpha:0},0).to({_off:true},1).wait(339));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({regX:-30.3,regY:20.4,skewX:-35.827,skewY:144.1725,x:158,y:-410.85},0).wait(1).to({regX:-31.4,regY:22.1,x:160.65,y:-409.8,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.4,x:158,y:-410.85,alpha:0,startPosition:19},0).to({_off:true},1).wait(262).to({_off:false,regX:-30.2,regY:20.5,skewX:-35.8376,skewY:144.173,x:157.95,y:-410.7,alpha:1,startPosition:0},0).wait(15).to({regX:-30.3,regY:20.4,skewX:-35.827,skewY:144.1725,x:158,y:-410.85},0).wait(1).to({regX:-31.4,regY:22.1,x:160.65,y:-409.8,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.4,x:158,y:-410.85,alpha:0,startPosition:19},0).to({_off:true},1).wait(36));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:120.7,y:-401.35,alpha:0.5556},0).wait(1).to({x:122.2,y:-410.4,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:123,y:-413.7,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:122.65,y:-412.8},0).wait(1).to({x:122.35,y:-410.7},0).wait(1).to({x:121.9,y:-407.2},0).wait(1).to({regX:0.1,regY:-0.1,x:121.6,y:-402.5},0).to({regY:0,x:121.8,y:-403.95},2).wait(8).to({regX:-0.2,regY:0.2,x:121.35,y:-403.15,alpha:0.9298},0).wait(1).to({x:121.05,y:-400.95,alpha:0.692},0).wait(1).to({x:120.65,y:-397.65,alpha:0.339},0).wait(1).to({x:120.3,y:-395.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:120.55,y:-394.7,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,regX:0.1,regY:-0.1,x:118.6,y:-386.5},0).wait(1).to({regX:-0.2,regY:0.2,x:120.7,y:-401.35,alpha:0.5556},0).wait(1).to({x:122.2,y:-410.4,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:123,y:-413.7,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:122.65,y:-412.8},0).wait(1).to({x:122.35,y:-410.7},0).wait(1).to({x:121.9,y:-407.2},0).wait(1).to({regX:0.1,regY:-0.1,x:121.6,y:-402.5},0).to({regY:0,x:121.8,y:-403.95},2).wait(3).to({regX:-0.2,regY:0.2,x:121.35,y:-403.15,alpha:0.9298},0).wait(1).to({x:121.05,y:-400.95,alpha:0.692},0).wait(1).to({x:120.65,y:-397.65,alpha:0.339},0).wait(1).to({x:120.3,y:-395.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:120.55,y:-394.7,alpha:0},0).to({_off:true},1).wait(251));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:107.5,y:-379},0).wait(1).to({y:-375.15},0).wait(1).to({y:-371.9},0).wait(1).to({y:-369.25},0).wait(1).to({y:-367.15},0).wait(1).to({y:-365.65},0).wait(1).to({y:-364.75},0).wait(1).to({regX:-0.5,regY:0.2,x:106.5,y:-363.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:107.5,y:-364.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:106.5,y:-363.7,alpha:0},0).to({_off:true},1).wait(209));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:143.125,y:-377.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:153.6,y:-376.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:111.7,y:-382.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:143.125,y:-382.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:153.6,y:-382.25,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:111.7,y:-382.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:143.125,y:-377.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:153.6,y:-376.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:111.7,y:-382.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:143.125,y:-382.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:153.6,y:-382.25,alpha:0.2188},0).to({_off:true},1).wait(166));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:73.1,y:-242.95,alpha:1},0).wait(1).to({regX:0.9,x:73.2,y:-242,alpha:0.8965},0).wait(1).to({x:74.55,y:-240.8,alpha:0.7636},0).wait(1).to({x:76.15,y:-239.35,alpha:0.6048},0).wait(1).to({x:77.95,y:-237.75,alpha:0.4229},0).wait(1).to({x:79.95,y:-235.9,alpha:0.2205},0).wait(1).to({regX:0,x:83.1,y:-233.95,alpha:0},0).to({_off:true},1).wait(139));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:108.1,y:-385.55},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:111.35,y:-391.4},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:108.8,y:-389.25},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:108.25,y:-386},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:109.35,y:-381.4},0).to({scaleX:1,scaleY:1,x:110.35,y:-385.4},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:107.75,y:-384.4,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:109.35,y:-385.15,alpha:0.1016},0).to({_off:true},1).wait(115));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-372.1},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-373.35},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:66,regY:-192,x:66,y:-200.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:66,regY:-192,x:66,y:-201.2},0).wait(1).to({y:-198.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:66,regY:-192,x:66,y:-197.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:66,regY:-192,x:66,y:-197.75},0).wait(1).to({y:-190.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:66,regY:-192,x:66,y:-188.75},0).wait(1).to({y:-191.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:66,regY:-192,x:66,y:-196.95},0).wait(1).to({y:-191.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:66,regY:-192,x:66,y:-196.95},0).wait(1).to({y:-191.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:66,regY:-192,x:66,y:-191.1},0).wait(1).to({y:-191.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:66,regY:-192,x:66,y:-201},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:66,regY:-192,x:66,y:-204.95},0).wait(1).to({y:-201.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:66,regY:-192,x:66,y:-190},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:66,regY:-192,x:66,y:-192.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:66,regY:-192,x:66,y:-201},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:66,regY:-192,x:66,y:-204.95},0).wait(1).to({y:-201.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:66,regY:-192,x:66,y:-190},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:66,regY:-192,x:66,y:-192.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:66,regY:-192,x:66,y:-191.4},0).wait(1).to({y:-189},0).wait(1).to({y:-186.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:66,regY:-192,x:66,y:-186.65},0).wait(1).to({y:-189},0).wait(1).to({y:-191.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:66,regY:-192,x:66,y:-191.85},0).wait(1).to({y:-191.3},0).wait(1).to({y:-190.2},0).wait(1).to({y:-188.85},0).wait(1).to({y:-187.75},0).wait(1).to({y:-187.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:66,regY:-192,x:66,y:-187.2},0).wait(1).to({y:-187.75},0).wait(1).to({y:-188.85},0).wait(1).to({y:-190.2},0).wait(1).to({y:-191.3},0).wait(1).to({y:-191.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:66,regY:-192,x:66,y:-187.25},0).wait(1).to({y:-190.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:66,regY:-192,x:66,y:-189.8},0).wait(1).to({y:-191.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:66,regY:-192,rotation:0.0244,x:66.1,y:-191.9},0).wait(1).to({rotation:0.1092,x:66.45,y:-191.55},0).wait(1).to({rotation:0.275,x:67.25,y:-190.8},0).wait(1).to({rotation:0.538,x:68.5,y:-189.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:70.05,y:-188.1},0).wait(1).to({rotation:1.1673,x:71.45,y:-186.75},0).wait(1).to({rotation:1.367,x:72.35,y:-185.8},0).wait(1).to({rotation:1.4695,x:72.8,y:-185.3},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:66,regY:-192,rotation:1.479,x:72.8,y:-185.35},0).wait(1).to({rotation:1.4111,x:72.5,y:-185.65},0).wait(1).to({rotation:1.2801,x:71.95,y:-186.3},0).wait(1).to({rotation:1.0711,x:70.95,y:-187.2},0).wait(1).to({rotation:0.7884,x:69.65,y:-188.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:68.25,y:-189.85},0).wait(1).to({rotation:0.2415,x:67.05,y:-190.9},0).wait(1).to({rotation:0.0832,x:66.35,y:-191.65},0).wait(1).to({rotation:0.0011,x:66,y:-192},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:66,regY:-192,rotation:0.0244,x:66.1,y:-191.9},0).wait(1).to({rotation:0.1092,x:66.45,y:-191.55},0).wait(1).to({rotation:0.275,x:67.25,y:-190.8},0).wait(1).to({rotation:0.538,x:68.5,y:-189.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:70.05,y:-188.1},0).wait(1).to({rotation:1.1673,x:71.45,y:-186.75},0).wait(1).to({rotation:1.367,x:72.35,y:-185.8},0).wait(1).to({rotation:1.4695,x:72.8,y:-185.3},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:66,regY:-192,rotation:1.4793,x:72.8,y:-185.35},0).wait(1).to({rotation:1.4124,x:72.5,y:-185.6},0).wait(1).to({rotation:1.2834,x:71.95,y:-186.25},0).wait(1).to({rotation:1.0775,x:70.95,y:-187.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:69.65,y:-188.45},0).wait(1).to({rotation:0.5016,x:68.3,y:-189.8},0).wait(1).to({rotation:0.2603,x:67.1,y:-190.9},0).wait(1).to({rotation:0.1043,x:66.4,y:-191.65},0).wait(1).to({rotation:0.0235,x:66.1,y:-191.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:66,regY:-192,x:66,y:-197.55},0).wait(1).to({y:-199.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:66,regY:-192,x:66,y:-199.35},0).wait(1).to({y:-197.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:66,regY:-192,x:66,y:-200.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:66,regY:-192,x:66,y:-201.2},0).wait(1).to({y:-198.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:66,regY:-192,rotation:-0.0253,x:65.9,y:-191.95},0).wait(1).to({rotation:-0.1129,x:65.7,y:-191.5},0).wait(1).to({rotation:-0.2845,x:65.4,y:-190.7},0).wait(1).to({rotation:-0.5565,x:64.85,y:-189.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:64.15,y:-187.8},0).wait(1).to({rotation:-1.2075,x:63.5,y:-186.35},0).wait(1).to({rotation:-1.4141,x:63,y:-185.35},0).wait(1).to({rotation:-1.5201,x:62.8,y:-184.85},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:66,regY:-192,rotation:-1.5305,x:62.75,y:-184.8},0).wait(1).to({rotation:-1.4624,x:62.9,y:-185.15},0).wait(1).to({rotation:-1.3309,x:63.2,y:-185.8},0).wait(1).to({rotation:-1.121,x:63.65,y:-186.8},0).wait(1).to({rotation:-0.8372,x:64.25,y:-188.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:64.85,y:-189.6},0).wait(1).to({rotation:-0.2881,x:65.35,y:-190.8},0).wait(1).to({rotation:-0.1291,x:65.65,y:-191.55},0).wait(1).to({rotation:-0.0467,x:65.85,y:-191.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:66,regY:-192,rotation:0.1421,x:66.6,y:-191.4},0).wait(1).to({rotation:0.6998,x:69.25,y:-188.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:72.2,y:-186},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:66,regY:-192,rotation:1.4399,x:72.6,y:-185.5},0).wait(1).to({rotation:1.2196,x:71.65,y:-186.55},0).wait(1).to({rotation:0.7884,x:69.65,y:-188.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:67.4,y:-190.6},0).wait(1).to({rotation:0.0482,x:66.15,y:-191.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:66,regY:-192,rotation:0.0865,x:66.4,y:-191.65},0).wait(1).to({rotation:0.4213,x:67.95,y:-190.1},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:70.65,y:-187.5},0).wait(1).to({rotation:1.3945,x:72.45,y:-185.65},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:66,regY:-192,rotation:1.4399,x:72.6,y:-185.5},0).wait(1).to({rotation:1.2196,x:71.65,y:-186.55},0).wait(1).to({rotation:0.7884,x:69.65,y:-188.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:67.4,y:-190.6},0).wait(1).to({rotation:0.0482,x:66.15,y:-191.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:66,regY:-192,x:66,y:-200.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:66,regY:-192,x:66,y:-201.2},0).wait(1).to({y:-198.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:66,regY:-192,x:63.25,y:-184.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:66,regY:-192,x:66,y:-179.75},0).wait(1).to({y:-182.7},0).wait(1).to({y:-187.65},0).wait(1).to({y:-191.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:66,regY:-192,x:66,y:-191},0).wait(1).to({y:-185.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:66,regY:-192,x:66,y:-184.2},0).wait(1).to({y:-188.5},0).wait(1).to({y:-192.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:66,regY:-192,x:66,y:-192.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:66,regY:-192,x:66,y:-198.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:66,regY:-192,x:66,y:-198.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:66,regY:-192,x:66,y:-200.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:66,regY:-192,x:66,y:-201.2},0).wait(1).to({y:-198.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:66,regY:-192,x:63.25,y:-184.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:66,regY:-192,x:66,y:-181.25},0).wait(1).to({y:-189},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:66,regY:-192,x:66,y:-193},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:66,regY:-192,x:66,y:-192.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:66,regY:-192,x:66,y:-191.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:66,regY:-192,x:66,y:-191.4},0).wait(1).to({y:-189},0).wait(1).to({y:-186.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:66,regY:-192,x:66,y:-186.6},0).wait(1).to({y:-186.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:66,regY:-192,x:66,y:-187.4},0).wait(1).to({y:-188.9},0).wait(1).to({y:-191.15},0).wait(1).to({y:-192.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:66,regY:-192,x:66,y:-192.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:66,regY:-192,x:66,y:-199.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:66,regY:-192,x:66,y:-201.2},0).wait(1).to({y:-198.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:66,regY:-192,x:66,y:-199.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:66,regY:-192,x:66,y:-200},0).wait(1).to({y:-194},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:66,regY:-192,x:66,y:-187.35},0).wait(1).to({y:-188.55},0).wait(1).to({y:-190.5},0).wait(1).to({y:-191.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:66,regY:-192,x:66,y:-196.95},0).wait(1).to({y:-191.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:66,regY:-192,x:66,y:-196.95},0).wait(1).to({y:-191.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:66,regY:-192,x:66,y:-191.1},0).wait(1).to({y:-191.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:66,regY:-192,x:69,y:-188.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:66,regY:-192,x:65.15,y:-182.55},0).wait(1).to({x:65.8,y:-182.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:66,regY:-192,x:66,y:-182.7},0).wait(1).to({y:-185.15},0).wait(1).to({y:-188.85},0).wait(1).to({y:-191.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(51).to({y:6},3).wait(1).to({regX:66,regY:-192,x:66,y:-186.65},0).wait(1).to({y:-189},0).wait(1).to({y:-191.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},3).wait(1).to({regX:66,regY:-192,x:66,y:-189},0).wait(1).to({y:-190.95},0).wait(1).to({y:-191.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-724.7,909.5,898.4000000000001);
...
// stage content:
(lib._410_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:150,scene2:151,end2:298,scene3:299,end3:470,scene4:471,end4:623,scene5:624,end5:760,scene6:761,end6:914,scene7:915,end7:1088});
	...
	this.frame_15 = function() {
		...
		this.bg1.gotoAndPlay("bg_gitter_start");
	}
	...
	this.frame_106 = function() {
		...
		//this.ch1.gotoAndPlay("chord_stop");
	}
	...
	this.frame_151 = function() {
		...
		exportRoot._u.setFace("ch1", 2);
		this.bg1.gotoAndPlay("bg_gitter_stop");
	}
	this.frame_189 = function() {
		exportRoot._g.m2 = "果が､今ここにっ! ";
		exportRoot._u.setText();
	...
	this.frame_235 = function() {
		...
		exportRoot._u.setFace("ch1", 5);
		this.ch1.gotoAndPlay("laugh_stop");
	}
	...
	this.frame_298 = function() {
		...
		exportRoot._u.setFace("ch1", 1);
		this.bg1.gotoAndPlay("bg_gitter_wait");
	}
	this.frame_299 = function() {
		exportRoot._g.m1 = "ですが､ﾌﾟﾛﾃﾞｭｰｻｰ! ";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_776 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "時には……";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 6);
	}
	this.frame_822 = function() {
		exportRoot._g.m2 = "時には……ふふっ♪";
		exportRoot._u.setText();
	...
	this.frame_882 = function() {
		exportRoot._g.m4 = "絶対絶対､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 6);
		this.ch2.gotoAndPlay("nod_double2");
	}
	...
	this.frame_915 = function() {
		...
		exportRoot._u.setFace("ch2", 6);
		this.ch2.gotoAndPlay("chord_stop");
	}
	this.frame_957 = function() {
		exportRoot._g.m2 = "ふわふわﾄﾞﾚｽ､";
		exportRoot._u.setText();
	...
	this.frame_1005 = function() {
		exportRoot._g.m3 = "和装も可愛いかも! ";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 2);
		this.ch2.gotoAndPlay("laugh_stop");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(14).call(this.frame_29).wait(29).call(this.frame_58).wait(32).call(this.frame_90).wait(16).call(this.frame_106).wait(30).call(this.frame_136).wait(14).call(this.frame_150).wait(1).call(this.frame_151).wait(38).call(this.frame_189).wait(23).call(this.frame_212).wait(23).call(this.frame_235).wait(42).call(this.frame_277).wait(21).call(this.frame_298).wait(1).call(this.frame_299).wait(27).call(this.frame_326).wait(29).call(this.frame_355).wait(10).call(this.frame_365).wait(10).call(this.frame_375).wait(29).call(this.frame_404).wait(32).call(this.frame_436).wait(10).call(this.frame_446).wait(24).call(this.frame_470).wait(1).call(this.frame_471).wait(20).call(this.frame_491).wait(17).call(this.frame_508).wait(28).call(this.frame_536).wait(13).call(this.frame_549).wait(14).call(this.frame_563).wait(31).call(this.frame_594).wait(29).call(this.frame_623).wait(1).call(this.frame_624).wait(64).call(this.frame_688).wait(36).call(this.frame_724).wait(20).call(this.frame_744).wait(16).call(this.frame_760).wait(1).call(this.frame_761).wait(15).call(this.frame_776).wait(46).call(this.frame_822).wait(14).call(this.frame_836).wait(14).call(this.frame_850).wait(32).call(this.frame_882).wait(18).call(this.frame_900).wait(14).call(this.frame_914).wait(1).call(this.frame_915).wait(42).call(this.frame_957).wait(24).call(this.frame_981).wait(24).call(this.frame_1005).wait(41).call(this.frame_1046).wait(18).call(this.frame_1064).wait(24).call(this.frame_1088).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1093));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1088).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1093));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1074));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1078));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1087));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1024).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1064).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1064).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1064).to({_off:false},0).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1064).to({_off:false},0).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1052).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(896).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(170));

	// fader
	this.instance_11 = new lib.dark();
	this.instance_11.parent = this;
	this.instance_11.setTransform(120,155);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},15).wait(1078));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(776).to({_off:false},0).to({alpha:1},46).to({_off:true},93).wait(178));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(776).to({_off:false},0).to({alpha:0.4492},46).to({_off:true},93).wait(178));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-753,542);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.4,regY:0.3,scaleX:0.8865,scaleY:0.8865,x:-73.15,y:240.7},0).wait(1).to({regX:46.8,regY:-276.5,scaleX:0.8863,scaleY:0.8863,x:-31.9,y:-4.6},0).wait(1).to({scaleX:0.886,scaleY:0.886,x:-31.8,y:-4.5},0).wait(1).to({scaleX:0.8854,scaleY:0.8854,x:-31.5,y:-4.2},0).wait(1).to({scaleX:0.8846,scaleY:0.8846,x:-31.1,y:-3.85},0).wait(1).to({scaleX:0.8835,scaleY:0.8835,x:-30.6,y:-3.25},0).wait(1).to({scaleX:0.882,scaleY:0.882,x:-29.9,y:-2.65},0).wait(1).to({scaleX:0.8803,scaleY:0.8803,x:-29.1,y:-1.85},0).wait(1).to({scaleX:0.8782,scaleY:0.8782,x:-28.15,y:-0.85},0).wait(1).to({scaleX:0.8757,scaleY:0.8757,x:-26.95,y:0.3},0).wait(1).to({scaleX:0.8727,scaleY:0.8727,x:-25.6,y:1.65},0).wait(1).to({scaleX:0.8694,scaleY:0.8694,x:-24.05,y:3.25},0).wait(1).to({scaleX:0.8655,scaleY:0.8655,x:-22.25,y:5},0).wait(1).to({scaleX:0.861,scaleY:0.861,x:-20.2,y:7.1},0).wait(1).to({scaleX:0.8559,scaleY:0.8559,x:-17.85,y:9.4},0).wait(1).to({scaleX:0.8502,scaleY:0.8502,x:-15.15,y:12.1},0).wait(1).to({scaleX:0.8437,scaleY:0.8437,x:-12.15,y:15.1},0).wait(1).to({scaleX:0.8363,scaleY:0.8363,x:-8.7,y:18.45},0).wait(1).to({scaleX:0.828,scaleY:0.828,x:-4.85,y:22.3},0).wait(1).to({scaleX:0.8186,scaleY:0.8186,x:-0.55,y:26.65},0).wait(1).to({scaleX:0.8081,scaleY:0.8081,x:4.35,y:31.45},0).wait(1).to({scaleX:0.7963,scaleY:0.7963,x:9.8,y:36.9},0).wait(1).to({scaleX:0.7833,scaleY:0.7833,x:15.85,y:42.95},0).wait(1).to({scaleX:0.769,scaleY:0.769,x:22.45,y:49.5},0).wait(1).to({scaleX:0.7538,scaleY:0.7538,x:29.55,y:56.55},0).wait(1).to({scaleX:0.7379,scaleY:0.7379,x:36.85,y:63.9},0).wait(1).to({scaleX:0.7219,scaleY:0.7219,x:44.25,y:71.25},0).wait(1).to({scaleX:0.7065,scaleY:0.7065,x:51.35,y:78.35},0).wait(1).to({scaleX:0.6923,scaleY:0.6923,x:58,y:84.95},0).wait(1).to({scaleX:0.6795,scaleY:0.6795,x:63.85,y:90.8},0).wait(1).to({scaleX:0.6685,scaleY:0.6685,x:69,y:95.9},0).wait(1).to({scaleX:0.6591,scaleY:0.6591,x:73.35,y:100.2},0).wait(1).to({scaleX:0.6513,scaleY:0.6513,x:76.95,y:103.8},0).wait(1).to({scaleX:0.6449,scaleY:0.6449,x:79.9,y:106.75},0).wait(1).to({scaleX:0.6398,scaleY:0.6398,x:82.3,y:109.15},0).wait(1).to({scaleX:0.6358,scaleY:0.6358,x:84.15,y:111},0).wait(1).to({scaleX:0.6327,scaleY:0.6327,x:85.6,y:112.4},0).wait(1).to({scaleX:0.6304,scaleY:0.6304,x:86.6,y:113.45},0).wait(1).to({scaleX:0.6289,scaleY:0.6289,x:87.35,y:114.15},0).wait(1).to({scaleX:0.6281,scaleY:0.6281,x:87.7,y:114.55},0).wait(1).to({regX:0.4,regY:0.5,scaleX:0.6278,scaleY:0.6278,x:58.7,y:288.45},0).wait(244).to({alpha:0.0117},9,cjs.Ease.get(1)).to({_off:true},1).wait(784));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(15).to({_off:false},0).to({_off:true},284).wait(794));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-1000,0,0.9998,0.9998);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.1,regY:-0.1,scaleX:0.8864,scaleY:0.8864,x:-292.35,y:-240.05},0).wait(1).to({regX:313,regY:350,scaleX:0.8863,scaleY:0.8863,x:-14.75,y:70.35},0).wait(1).to({scaleX:0.886,scaleY:0.886,x:-14.6,y:70.5},0).wait(1).to({scaleX:0.8854,scaleY:0.8854,x:-14.35,y:70.7},0).wait(1).to({scaleX:0.8845,scaleY:0.8845,x:-13.95,y:71.05},0).wait(1).to({scaleX:0.8834,scaleY:0.8834,x:-13.45,y:71.45},0).wait(1).to({scaleX:0.882,scaleY:0.882,x:-12.8,y:72},0).wait(1).to({scaleX:0.8802,scaleY:0.8802,x:-12.05,y:72.65},0).wait(1).to({scaleX:0.8781,scaleY:0.8781,x:-11.1,y:73.45},0).wait(1).to({scaleX:0.8756,scaleY:0.8756,x:-10,y:74.35},0).wait(1).to({scaleX:0.8727,scaleY:0.8727,x:-8.7,y:75.45},0).wait(1).to({scaleX:0.8693,scaleY:0.8693,x:-7.2,y:76.7},0).wait(1).to({scaleX:0.8654,scaleY:0.8654,x:-5.45,y:78.2},0).wait(1).to({scaleX:0.861,scaleY:0.861,x:-3.45,y:79.85},0).wait(1).to({scaleX:0.8559,scaleY:0.8559,x:-1.25,y:81.75},0).wait(1).to({scaleX:0.8501,scaleY:0.8501,x:1.3,y:83.9},0).wait(1).to({scaleX:0.8436,scaleY:0.8436,x:4.2,y:86.35},0).wait(1).to({scaleX:0.8362,scaleY:0.8362,x:7.5,y:89.15},0).wait(1).to({scaleX:0.8279,scaleY:0.8279,x:11.2,y:92.2},0).wait(1).to({scaleX:0.8186,scaleY:0.8186,x:15.3,y:95.75},0).wait(1).to({scaleX:0.808,scaleY:0.808,x:20,y:99.7},0).wait(1).to({scaleX:0.7963,scaleY:0.7963,x:25.25,y:104.1},0).wait(1).to({scaleX:0.7832,scaleY:0.7832,x:31,y:109},0).wait(1).to({scaleX:0.769,scaleY:0.769,x:37.3,y:114.3},0).wait(1).to({scaleX:0.7537,scaleY:0.7537,x:44.05,y:120.05},0).wait(1).to({scaleX:0.7378,scaleY:0.7378,x:51.15,y:126},0).wait(1).to({scaleX:0.7219,scaleY:0.7219,x:58.2,y:132},0).wait(1).to({scaleX:0.7065,scaleY:0.7065,x:65.05,y:137.75},0).wait(1).to({scaleX:0.6922,scaleY:0.6922,x:71.35,y:143.1},0).wait(1).to({scaleX:0.6795,scaleY:0.6795,x:77,y:147.85},0).wait(1).to({scaleX:0.6685,scaleY:0.6685,x:81.9,y:151.95},0).wait(1).to({scaleX:0.6591,scaleY:0.6591,x:86.05,y:155.5},0).wait(1).to({scaleX:0.6513,scaleY:0.6513,x:89.5,y:158.4},0).wait(1).to({scaleX:0.6449,scaleY:0.6449,x:92.35,y:160.85},0).wait(1).to({scaleX:0.6398,scaleY:0.6398,x:94.6,y:162.75},0).wait(1).to({scaleX:0.6358,scaleY:0.6358,x:96.4,y:164.25},0).wait(1).to({scaleX:0.6327,scaleY:0.6327,x:97.8,y:165.4},0).wait(1).to({scaleX:0.6304,scaleY:0.6304,x:98.8,y:166.25},0).wait(1).to({scaleX:0.6289,scaleY:0.6289,x:99.45,y:166.85},0).wait(1).to({scaleX:0.6281,scaleY:0.6281,x:99.85,y:167.15},0).wait(1).to({regX:-0.3,regY:-0.1,scaleX:0.6278,scaleY:0.6278,x:-96.7,y:-52.55},0).wait(244).to({alpha:0.0117},9,cjs.Ease.get(1)).to({_off:true},1).wait(784));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-757.6,329.5,0.68,0.68,0,0,0,0.6,0.7);
	this.ch2.alpha = 0.0117;
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(285).to({_off:false},0).wait(14).to({regX:0.7,regY:0.8,scaleX:0.748,scaleY:0.748,x:87.45,y:343.3,alpha:1},0).wait(1).to({regX:46.8,regY:-276.5,x:122.6,y:136.25},0).wait(1).to({x:123.3,y:136.7},0).wait(1).to({x:124.1,y:137.2},0).wait(1).to({x:125,y:137.7},0).wait(1).to({x:125.85,y:138.25},0).wait(1).to({x:126.75,y:138.8},0).wait(1).to({x:127.65,y:139.3},0).wait(1).to({x:128.55,y:139.85},0).wait(1).to({x:129.35,y:140.35},0).wait(1).to({x:130.1,y:140.8},0).wait(1).to({x:130.75,y:141.2},0).wait(1).to({x:131.35,y:141.55},0).wait(1).to({x:131.85,y:141.85},0).wait(1).to({x:132.25,y:142.05},0).wait(1).to({x:132.55,y:142.25},0).wait(1).to({x:132.75,y:142.4},0).wait(1).to({x:132.9,y:142.45},0).wait(1).to({regX:0.7,regY:0.8,x:98.45,y:349.9},0).wait(155).to({regX:46.8,regY:-276.5,x:132.9,y:142.45},0).wait(1).to({scaleX:0.7483,scaleY:0.7483,y:142.5},0).wait(1).to({scaleX:0.7488,scaleY:0.7488,x:132.95},0).wait(1).to({scaleX:0.7495,scaleY:0.7495,x:132.9,y:142.55},0).wait(1).to({scaleX:0.7504,scaleY:0.7504},0).wait(1).to({scaleX:0.7516,scaleY:0.7516,y:142.65},0).wait(1).to({scaleX:0.7531,scaleY:0.7531,x:132.95,y:142.7},0).wait(1).to({scaleX:0.7549,scaleY:0.7549,y:142.75},0).wait(1).to({scaleX:0.757,scaleY:0.757,y:142.9},0).wait(1).to({scaleX:0.7594,scaleY:0.7594,y:143.05},0).wait(1).to({scaleX:0.762,scaleY:0.762,x:132.9,y:143.15},0).wait(1).to({scaleX:0.7648,scaleY:0.7648,x:132.95,y:143.25},0).wait(1).to({scaleX:0.7676,scaleY:0.7676,y:143.4},0).wait(1).to({scaleX:0.7703,scaleY:0.7703,x:132.9,y:143.5},0).wait(1).to({scaleX:0.7726,scaleY:0.7726,y:143.65},0).wait(1).to({scaleX:0.7746,scaleY:0.7746,y:143.75},0).wait(1).to({scaleX:0.7761,scaleY:0.7761,y:143.8},0).wait(1).to({scaleX:0.7771,scaleY:0.7771,y:143.9},0).wait(1).to({scaleX:0.7777,scaleY:0.7777},0).wait(1).to({regX:0.7,regY:0.8,scaleX:0.7779,scaleY:0.7779,x:97.05,y:359.6},0).wait(286).to({regX:46.8,regY:-276.5,x:132.85,y:143.9},0).wait(1).to({scaleX:0.778,scaleY:0.778,y:143.95},0).wait(1).to({scaleX:0.7782,scaleY:0.7782},0).wait(1).to({scaleX:0.7785,scaleY:0.7785,x:132.9},0).wait(1).to({scaleX:0.7788,scaleY:0.7788},0).wait(1).to({scaleX:0.7793,scaleY:0.7793,x:132.85,y:144},0).wait(1).to({scaleX:0.7798,scaleY:0.7798,x:132.9,y:144.05},0).wait(1).to({scaleX:0.7805,scaleY:0.7805},0).wait(1).to({scaleX:0.7812,scaleY:0.7812,x:132.85,y:144.1},0).wait(1).to({scaleX:0.7821,scaleY:0.7821,x:132.9,y:144.15},0).wait(1).to({scaleX:0.7831,scaleY:0.7831,y:144.2},0).wait(1).to({scaleX:0.7841,scaleY:0.7841,y:144.3},0).wait(1).to({scaleX:0.7853,scaleY:0.7853,y:144.35},0).wait(1).to({scaleX:0.7867,scaleY:0.7867,x:132.85,y:144.45},0).wait(1).to({scaleX:0.7881,scaleY:0.7881,x:132.9,y:144.55},0).wait(1).to({scaleX:0.7897,scaleY:0.7897,y:144.6},0).wait(1).to({scaleX:0.7914,scaleY:0.7914,y:144.7},0).wait(1).to({scaleX:0.7933,scaleY:0.7933,y:144.8},0).wait(1).to({scaleX:0.7953,scaleY:0.7953,y:144.95},0).wait(1).to({scaleX:0.7974,scaleY:0.7974,y:145.05},0).wait(1).to({scaleX:0.7997,scaleY:0.7997,y:145.25},0).wait(1).to({scaleX:0.8021,scaleY:0.8021,y:145.35},0).wait(1).to({scaleX:0.8046,scaleY:0.8046,y:145.5},0).wait(1).to({scaleX:0.8073,scaleY:0.8073,x:132.95,y:145.65},0).wait(1).to({scaleX:0.81,scaleY:0.81,x:132.9,y:145.85},0).wait(1).to({scaleX:0.8128,scaleY:0.8128,y:146},0).wait(1).to({scaleX:0.8157,scaleY:0.8157,y:146.15},0).wait(1).to({scaleX:0.8185,scaleY:0.8185,y:146.35},0).wait(1).to({scaleX:0.8214,scaleY:0.8214,x:132.95,y:146.5},0).wait(1).to({scaleX:0.8242,scaleY:0.8242,x:132.9,y:146.65},0).wait(1).to({scaleX:0.827,scaleY:0.827,y:146.85},0).wait(1).to({scaleX:0.8296,scaleY:0.8296,x:132.95,y:147},0).wait(1).to({scaleX:0.8322,scaleY:0.8322,y:147.15},0).wait(1).to({scaleX:0.8345,scaleY:0.8345,y:147.3},0).wait(1).to({scaleX:0.8367,scaleY:0.8367,y:147.45},0).wait(1).to({scaleX:0.8387,scaleY:0.8387,y:147.55},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,y:147.65},0).wait(1).to({scaleX:0.8421,scaleY:0.8421,y:147.75},0).wait(1).to({scaleX:0.8435,scaleY:0.8435,y:147.8},0).wait(1).to({scaleX:0.8447,scaleY:0.8447,y:147.9},0).wait(1).to({scaleX:0.8457,scaleY:0.8457,y:147.95},0).wait(1).to({scaleX:0.8465,scaleY:0.8465,y:148},0).wait(1).to({scaleX:0.8471,scaleY:0.8471},0).wait(1).to({scaleX:0.8475,scaleY:0.8475,y:148.05},0).wait(1).to({scaleX:0.8478,scaleY:0.8478,y:148.1},0).wait(1).to({regX:0.8,regY:0.8,scaleX:0.8479,scaleY:0.8479,x:93.95,y:383.25},0).wait(93).to({regX:0.6,regY:0.7,scaleX:0.6095,scaleY:0.6095,x:63,y:285.05},0).to({_off:true},149).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(299).to({_off:false},0).to({_off:true},765).wait(29));

	// bg_blur
	this.bg1_1 = new lib.bg_zoom_half_blur();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-926,-39,0.6799,0.6799);
	this.bg1_1.alpha = 0.0117;
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(285).to({_off:false},0).wait(14).to({regX:-0.1,regY:-0.1,scaleX:0.7479,scaleY:0.7479,x:-97.8,y:-62.05,alpha:1},0).wait(1).to({regX:313,regY:350,x:137.05,y:200.15},0).wait(1).to({x:137.75,y:200.6},0).wait(1).to({x:138.55,y:201.1},0).wait(1).to({x:139.45,y:201.6},0).wait(1).to({x:140.3,y:202.15},0).wait(1).to({x:141.2,y:202.7},0).wait(1).to({x:142.1,y:203.2},0).wait(1).to({x:143,y:203.75},0).wait(1).to({x:143.8,y:204.25},0).wait(1).to({x:144.55,y:204.7},0).wait(1).to({x:145.2,y:205.1},0).wait(1).to({x:145.8,y:205.45},0).wait(1).to({x:146.3,y:205.75},0).wait(1).to({x:146.7,y:205.95},0).wait(1).to({x:147,y:206.15},0).wait(1).to({x:147.2,y:206.3},0).wait(1).to({x:147.35,y:206.35},0).wait(1).to({regX:-0.1,regY:-0.1,x:-86.8,y:-55.45},0).wait(155).to({regX:313,regY:350,scaleX:0.748,scaleY:0.748,x:147.35,y:206.4},0).wait(1).to({scaleX:0.7483,scaleY:0.7483,y:206.45},0).wait(1).to({scaleX:0.7487,scaleY:0.7487,x:147.4,y:206.5},0).wait(1).to({scaleX:0.7494,scaleY:0.7494,y:206.6},0).wait(1).to({scaleX:0.7504,scaleY:0.7504,y:206.75},0).wait(1).to({scaleX:0.7516,scaleY:0.7516,x:147.45,y:206.9},0).wait(1).to({scaleX:0.7531,scaleY:0.7531,y:207.05},0).wait(1).to({scaleX:0.7549,scaleY:0.7549,x:147.5,y:207.35},0).wait(1).to({scaleX:0.757,scaleY:0.757,x:147.55,y:207.65},0).wait(1).to({scaleX:0.7594,scaleY:0.7594,x:147.6,y:207.9},0).wait(1).to({scaleX:0.762,scaleY:0.762,x:147.65,y:208.3},0).wait(1).to({scaleX:0.7648,scaleY:0.7648,x:147.7,y:208.7},0).wait(1).to({scaleX:0.7676,scaleY:0.7676,x:147.75,y:209.05},0).wait(1).to({scaleX:0.7703,scaleY:0.7703,x:147.8,y:209.4},0).wait(1).to({scaleX:0.7726,scaleY:0.7726,x:147.85,y:209.7},0).wait(1).to({scaleX:0.7746,scaleY:0.7746,x:147.9,y:210},0).wait(1).to({scaleX:0.776,scaleY:0.776,y:210.15},0).wait(1).to({scaleX:0.7771,scaleY:0.7771,y:210.3},0).wait(1).to({scaleX:0.7776,scaleY:0.7776,x:147.95,y:210.35},0).wait(1).to({regX:-0.1,regY:-0.1,scaleX:0.7778,scaleY:0.7778,x:-95.65,y:-61.95},0).wait(286).to({regX:313,regY:350,scaleX:0.7779,scaleY:0.7779,x:147.9,y:210.4},0).wait(1).to({scaleX:0.778,scaleY:0.778,x:147.95,y:210.45},0).wait(1).to({scaleX:0.7782,scaleY:0.7782,x:147.9},0).wait(1).to({scaleX:0.7784,scaleY:0.7784,x:147.95,y:210.5},0).wait(1).to({scaleX:0.7788,scaleY:0.7788,y:210.55},0).wait(1).to({scaleX:0.7793,scaleY:0.7793,y:210.65},0).wait(1).to({scaleX:0.7798,scaleY:0.7798,x:148,y:210.7},0).wait(1).to({scaleX:0.7805,scaleY:0.7805,y:210.8},0).wait(1).to({scaleX:0.7812,scaleY:0.7812,y:210.9},0).wait(1).to({scaleX:0.7821,scaleY:0.7821,x:148.05,y:211},0).wait(1).to({scaleX:0.783,scaleY:0.783,y:211.15},0).wait(1).to({scaleX:0.7841,scaleY:0.7841,y:211.35},0).wait(1).to({scaleX:0.7853,scaleY:0.7853,x:148.1,y:211.5},0).wait(1).to({scaleX:0.7866,scaleY:0.7866,y:211.7},0).wait(1).to({scaleX:0.7881,scaleY:0.7881,y:211.95},0).wait(1).to({scaleX:0.7897,scaleY:0.7897,x:148.15,y:212.15},0).wait(1).to({scaleX:0.7914,scaleY:0.7914,x:148.2,y:212.4},0).wait(1).to({scaleX:0.7933,scaleY:0.7933,x:148.25,y:212.65},0).wait(1).to({scaleX:0.7953,scaleY:0.7953,y:212.95},0).wait(1).to({scaleX:0.7974,scaleY:0.7974,x:148.35,y:213.25},0).wait(1).to({scaleX:0.7997,scaleY:0.7997,x:148.4,y:213.6},0).wait(1).to({scaleX:0.8021,scaleY:0.8021,y:213.95},0).wait(1).to({scaleX:0.8046,scaleY:0.8046,x:148.5,y:214.3},0).wait(1).to({scaleX:0.8072,scaleY:0.8072,y:214.7},0).wait(1).to({scaleX:0.81,scaleY:0.81,x:148.55,y:215.1},0).wait(1).to({scaleX:0.8128,scaleY:0.8128,x:148.65,y:215.5},0).wait(1).to({scaleX:0.8156,scaleY:0.8156,x:148.7,y:215.9},0).wait(1).to({scaleX:0.8185,scaleY:0.8185,x:148.75,y:216.3},0).wait(1).to({scaleX:0.8214,scaleY:0.8214,x:148.85,y:216.75},0).wait(1).to({scaleX:0.8242,scaleY:0.8242,y:217.15},0).wait(1).to({scaleX:0.8269,scaleY:0.8269,x:148.95,y:217.6},0).wait(1).to({scaleX:0.8296,scaleY:0.8296,y:217.95},0).wait(1).to({scaleX:0.8321,scaleY:0.8321,x:149.05,y:218.35},0).wait(1).to({scaleX:0.8345,scaleY:0.8345,x:149.1,y:218.65},0).wait(1).to({scaleX:0.8367,scaleY:0.8367,x:149.15,y:219},0).wait(1).to({scaleX:0.8387,scaleY:0.8387,y:219.3},0).wait(1).to({scaleX:0.8405,scaleY:0.8405,x:149.2,y:219.5},0).wait(1).to({scaleX:0.8421,scaleY:0.8421,x:149.25,y:219.8},0).wait(1).to({scaleX:0.8435,scaleY:0.8435,y:220},0).wait(1).to({scaleX:0.8447,scaleY:0.8447,x:149.3,y:220.15},0).wait(1).to({scaleX:0.8457,scaleY:0.8457,y:220.3},0).wait(1).to({scaleX:0.8465,scaleY:0.8465,x:149.35,y:220.4},0).wait(1).to({scaleX:0.8471,scaleY:0.8471,y:220.55},0).wait(1).to({scaleX:0.8475,scaleY:0.8475},0).wait(1).to({scaleX:0.8477,scaleY:0.8477,y:220.6},0).wait(1).to({regX:-0.2,regY:-0.1,scaleX:0.8478,scaleY:0.8478,x:-116.15,y:-76.25},0).to({_off:true},93).wait(178));

	// bg
	this.bg1_2 = new lib.bg_zoom_half();
	this.bg1_2.name = "bg1_2";
	this.bg1_2.parent = this;
	this.bg1_2.setTransform(-88,-46.1,0.6095,0.6095,0,0,0,-0.3,-0.1);
	this.bg1_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_2).wait(915).to({_off:false},0).to({_off:true},149).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1064).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1064).wait(24).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-880,-720,1500,1420);
// library properties:
lib.properties = {
	id: '_410_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1592386548485", id:"_410_2_bg"},
		{src:"images/bg_blur.jpg?1592386548485", id:"_410_2_bg_blur"},
		{src:"images/ch_base.png?1592386548485", id:"_410_2_ch_base"},
		{src:"images/ch_face2.png?1592386548485", id:"_410_2_ch_face2"},
		{src:"images/ch_face3.png?1592386548485", id:"_410_2_ch_face3"},
		{src:"images/ch_face4.png?1592386548485", id:"_410_2_ch_face4"},
		{src:"images/ch_face5.png?1592386548485", id:"_410_2_ch_face5"},
		{src:"images/ch_face6.png?1592386548485", id:"_410_2_ch_face6"},
		{src:"images/ch_face7.png?1592386548485", id:"_410_2_ch_face7"},
		{src:"images/ch_face8.png?1592386548485", id:"_410_2_ch_face8"},
		{src:"images/finish.jpg?1592386548485", id:"_410_2_finish"},
		{src:"images/finish_blur.jpg?1592386548485", id:"_410_2_finish_blur"},
		{src:"images/tie_fp.png?1592386548485", id:"_410_2_tie_fp"},
		{src:"images/tie_sp.png?1592386548485", id:"_410_2_tie_sp"}
	],
	preloads: []
};

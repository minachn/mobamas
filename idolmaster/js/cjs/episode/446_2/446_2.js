...
(lib.bg = function() {
	this.initialize(img._446_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,920,1400);


(lib.ch_base = function() {
	this.initialize(img._446_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,920,1400);


(lib.ch_face1 = function() {
	this.initialize(img._446_2_ch_face1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face2 = function() {
	this.initialize(img._446_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face3 = function() {
	this.initialize(img._446_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face4 = function() {
	this.initialize(img._446_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face5 = function() {
	this.initialize(img._446_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face6 = function() {
	this.initialize(img._446_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face7 = function() {
	this.initialize(img._446_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face8 = function() {
	this.initialize(img._446_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ef1 = function() {
	this.initialize(img._446_2_ef1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,232,225);


(lib.ef2 = function() {
	this.initialize(img._446_2_ef2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,920,1400);


(lib.finish = function() {
	this.initialize(img._446_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._446_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._446_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._446_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.eff02 = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.instance = new lib.ef1();
	this.instance.parent = this;
	this.instance.setTransform(-173.35,-21.75,0.9999,0.9999,-37.7324);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-173.3,-163.7,321.1,319.9);


(lib.ef = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// bg_image
	this.instance = new lib.ef2();
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(0,10,460,700);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,130,130), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,460,700), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,460,700);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(64.85,-0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AgpApQAZgGAQgMQARgLAJgSQAJgTABgdIASADQgCAUgFARQgFAQgJANQgJAOgPAJQgOAKgYAHgAgrgPIgEgQIgGgOIAPgEIAGANIAFAQIAEAPIgQAFIgEgPgAgGgTIgEgRIgEgOIAOgDIAFAOIAEAPIADAPIgPAEIgDgOg");
	this.shape_1.setTransform(47.95,2.125);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AAjA0IAAgGIhVAAIAAgPIBVAAIAAgdIhPAAIAAgNIBPAAIAAgaIhTAAIAAgOIBjAAIAABng");
	this.shape_2.setTransform(31.925,2.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("Ag9AyQAbgCAUgJQATgJAOgNQAOgOAJgPQAJgQAGgSIAPAMIgKAXQgGAMgJAMQgJANgNALQgOAKgSAJQgSAHgaAEgAgnAAIgQgIIgQgGIAJgPIAPAFIARAIIAQAJIgIAPIgRgIgAgRgnIgQgHIgQgGIAJgPIAPAGIARAHQAIADAGAFIgHARIgQgKg");
	this.shape_3.setTransform(16.275,0.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AhLA6QAMgJAHgMQAIgLADgOQAEgMACgOQABgOAAgOIAAgMIAAgMIASAAIAAALQgBAdgCAWQgDAVgIASQgIASgPAPgAAAAgIAAggIAAhDIAQAAIAAAMIAAARIAAAVIAAAVIAAAVIAAAPQALgFAJgKQAJgJAHgMQAGgLAFgMIANAPQgEAJgIAMQgGALgKAKQgKAKgMAIQgMAHgOADIAAgig");
	this.shape_4.setTransform(0.15,0.525);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(-15.725,0.125);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("AAGBHIAAhLQgOAJgPAIIgeAMIgOgPQAmgLAegUQAegUAUgdIARAJQgKAOgLAKQgLALgLAJIAAAOIAAARIAAAVIAAAUIAAAQg");
	this.shape_6.setTransform(-32.4,0.45);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AgyA0QAggDATgJQAUgJAKgNQALgPABgQIgSAAIgWAAIgXAAIgVAAIgQABIgGAAIAAgQIB/AAQgBApgaAYQgaAYgxAIgAgyg0IAAgQIBlAAIAAAQg");
	this.shape_7.setTransform(-48.05,0.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AhAA7QAagFATgJQASgKAKgMQAMgNAGgOQAGgPACgRIgSAAIgVABIgYAAIgVAAIgQAAIgGAAIAAgRIAGAAIANAAIAUAAIAWAAIAWAAIAVAAIgEgIIgFgIIALgEIAGAKIAFAKIAKAAQgBAigNAZQgMAagXARQgWARgjAIgAA3g5IgIgNIALgEIAHANIAHANIgLAEIgGgNg");
	this.shape_8.setTransform(-63.225,-0.025);
...
(lib.eff02_m = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(92));

	// レイヤー_1
	this.instance_1 = new lib.eff02("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-0.1,0,0.1705,0.1705,-119.8047,0,0,0.3,-0.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(79).to({_off:false},0).to({regX:0,regY:0.1,scaleX:0.6995,scaleY:0.6995,rotation:45,x:-0.25,y:0.25},6).to({regX:-0.2,regY:-0.6,scaleX:0.1705,scaleY:0.1705,rotation:198.2582,x:0,y:0.1},6).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-97.3,-104,193.6,192.4);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("Ap/KAIAAz/IT/AAIAAT/g");
	mask.setTransform(65,65);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-80,182);
	this.b._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.b).wait(12).to({_off:false},0).wait(8));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(1,1,128,128);
...
(lib.window = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(23.675,11.775);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AEyFFQghgGg4ggQg+gjgcgjQgcgihCgsQg6gng9gdQgqgTg6AKQhBAMgVgFQg3gMgjgJQhAgRgWgQQgwgjgQgVQgmgygChSQgBhYBmgrQBdgmBbAYQBgAZAzBJQAcAnAXA3QAQAZAXgBQASAAA0gVQBHgcA3gHQBVgLA+AiQBIAoAlAiQAnAjAoA+QBYCJg+BbQgdAshTAOQglAGgeAAQgXAAgTgDg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:61.8803,y:55.9944}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:65,regY:65,x:65,y:65,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:65,regY:65,x:65,y:65,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:65,regY:65,x:65,y:65,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:65,regY:65,x:65,y:65,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-107.2,-240.25,0.1297,0.129,14.3634,0,0,20.4,-10.5);
	this.instance.compositeOperation = "lighter";

	this.instance_1 = new lib.eff02_m();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-80.65,-144.3,0.1515,0.1507,14.3641,0,0,20.5,-10.4);
	this.instance_1.compositeOperation = "lighter";

	this.instance_2 = new lib.eff02_m();
	this.instance_2.parent = this;
	this.instance_2.setTransform(183.1,-197.55,0.1233,0.1226,14.3648,0,0,20.9,-10);
	this.instance_2.compositeOperation = "lighter";

	this.instance_3 = new lib.eff02_m();
	this.instance_3.parent = this;
	this.instance_3.setTransform(138.4,-158.15,0.1233,0.1226,14.3648,0,0,20.9,-10);
	this.instance_3.compositeOperation = "lighter";

	this.instance_4 = new lib.eff02_m();
	this.instance_4.parent = this;
	this.instance_4.setTransform(44.15,-165.1,0.1233,0.1226,14.3648,0,0,20.9,-10);
	this.instance_4.compositeOperation = "lighter";

	this.instance_5 = new lib.eff02_m();
	this.instance_5.parent = this;
	this.instance_5.setTransform(18.55,-163,0.2295,0.2282,14.3698,0,0,1.4,-1.5);
	this.instance_5.compositeOperation = "lighter";

	this.instance_6 = new lib.eff02_m();
	this.instance_6.parent = this;
	this.instance_6.setTransform(27.5,-61.45,0.1539,0.1539,14.4469,0,0,0.1,-0.7);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-90,-158);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-210,-554,520.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(19).call(this.frame_461).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-3.2,-371.15,1.1645,1.1645);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-13.9,-320.25,0.4532,0.4532);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-28.8,y:-380.15,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-40.45,y:-384.45,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-3.2,y:-371.15,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-28.8,y:-380.15,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-40.45,y:-384.45,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-3.2,y:-371.15,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-28.8,y:-380.15,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-40.45,y:-384.45,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-3.2,y:-371.15,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-28.8,y:-380.15,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-40.45,y:-384.45,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-15.65,y:-334.4,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-18.9,y:-340.25,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-16.35,y:-338.1,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-15.8,y:-334.85,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-16.9,y:-330.25,alpha:0},0).to({_off:true},1).wait(86));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(50.95,-277,1.4808,1.4808);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(50.95,-277,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-20.75,-367.05,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-41.5,-361.65,1.4204,1.4204,35.8424,0,0,-30.2,20.6);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-13.85,-279.4,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-14.5,-364,1.053,1.053,-28.4906);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-16.75,-378.7,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-11.25,-360.1,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-5,-361.4,0.9876,0.9876,14.9998);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-14.6,-365.05,1.3878,1.3878,-121.2396);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(7.9,-210.65);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-13.9,-320.25,0.4532,0.4532);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(124.05,-340.35,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-7,-389.5,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-51.05,-280.15,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},37).to({state:[{t:this.instance_3}]},10).to({state:[]},10).to({state:[{t:this.instance_4}]},76).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},2).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},15).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},20).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},7).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},6).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},16).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},24).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},11).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},11).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},2).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},6).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},5).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},2).to({state:[]},12).to({state:[{t:this.instance_16}]},17).to({state:[{t:this.instance_6}]},9).wait(20));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-20.4,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-20.75,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-20.4,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-20.75,alpha:0},0).to({_off:true},1).wait(303));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-44.2,y:-360.9,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-41.5,y:-361.65,alpha:0,startPosition:19},0).to({_off:true},1).wait(282));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-21.45,y:-377.4,alpha:0.5556},0).wait(1).to({x:-25.55,y:-385.65,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-26.85,y:-388.7,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-26.6,y:-387.75},0).wait(1).to({x:-25.6,y:-385.9},0).wait(1).to({x:-23.9,y:-382.75},0).wait(1).to({regX:0,regY:0,x:-21.45,y:-378.7},0).to({x:-22.2,y:-380.05},2).wait(8).to({regX:-0.2,regY:0.2,x:-21.95,y:-379.15,alpha:0.9298},0).wait(1).to({x:-20.9,y:-377.2,alpha:0.692},0).wait(1).to({x:-19.3,y:-374.3,alpha:0.339},0).wait(1).to({x:-18.15,y:-372.15,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-17.7,y:-371.85,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-14.95,y:-363.6},0).wait(1).to({regX:-0.2,regY:0.2,x:-21.9,y:-377,alpha:0.5556},0).wait(1).to({x:-26,y:-385.25,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-27.3,y:-388.3,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-27.05,y:-387.35},0).wait(1).to({x:-26.05,y:-385.5},0).wait(1).to({x:-24.35,y:-382.35},0).wait(1).to({regX:0,regY:0,x:-21.9,y:-378.3},0).to({x:-22.65,y:-379.65},2).wait(3).to({regX:-0.2,regY:0.2,x:-22.4,y:-378.75,alpha:0.9298},0).wait(1).to({x:-21.35,y:-376.8,alpha:0.692},0).wait(1).to({x:-19.75,y:-373.9,alpha:0.339},0).wait(1).to({x:-18.6,y:-371.75,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-18.15,y:-371.45,alpha:0},0).to({_off:true},1).wait(215));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-10.25,y:-356.4},0).wait(1).to({y:-352.55},0).wait(1).to({y:-349.3},0).wait(1).to({y:-346.65},0).wait(1).to({y:-344.55},0).wait(1).to({y:-343.05},0).wait(1).to({y:-342.15},0).wait(1).to({regX:-0.5,regY:0.2,x:-11.25,y:-341.1},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-10.25,y:-341.9,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-11.25,y:-341.1,alpha:0},0).to({_off:true},1).wait(173));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-36.425,y:-356.7875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-46.9,y:-355.25,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-5,y:-361.4,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-36.425,y:-361.175,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-46.9,y:-361.1,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-5,y:-361.4,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-36.425,y:-356.7875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-46.9,y:-355.25,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-5,y:-361.4,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-36.425,y:-361.175,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-46.9,y:-361.1,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:6.9,y:-209.65,alpha:1},0).wait(1).to({regX:0.9,x:6.75,y:-208.7,alpha:0.8965},0).wait(1).to({x:5.4,y:-207.5,alpha:0.7636},0).wait(1).to({x:3.8,y:-206.05,alpha:0.6048},0).wait(1).to({x:2,y:-204.45,alpha:0.4229},0).wait(1).to({x:0.05,y:-202.6,alpha:0.2205},0).wait(1).to({regX:0,x:-3.1,y:-200.65,alpha:0},0).to({_off:true},1).wait(103));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-15.65,y:-334.4},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-18.9,y:-340.25},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-16.35,y:-338.1},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-15.8,y:-334.85},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-16.9,y:-330.25},0).to({scaleX:1,scaleY:1,x:-17.9,y:-334.25},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-15.3,y:-333.25,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-16.9,y:-334,alpha:0.1016},0).to({_off:true},1).wait(79));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-344.1},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-345.35},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:20,regY:-204,x:20,y:-207.2},0).wait(1).to({regX:0,regY:0,x:0,y:-3.85},0).wait(1).to({regX:20,regY:-204,x:20,y:-207.4},0).wait(1).to({y:-205.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:20,regY:-204,x:20,y:-209.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:20,regY:-204,x:20,y:-209.75},0).wait(1).to({y:-202.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:20,regY:-204,x:20,y:-200.75},0).wait(1).to({y:-203.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:20,regY:-204,x:20,y:-208.95},0).wait(1).to({y:-203.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:20,regY:-204,x:20,y:-208.95},0).wait(1).to({y:-203.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:20,regY:-204,x:20,y:-203.1},0).wait(1).to({y:-203.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:20,regY:-204,x:20,y:-213},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:20,regY:-204,x:20,y:-216.95},0).wait(1).to({y:-213.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:20,regY:-204,x:20,y:-202},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:20,regY:-204,x:20,y:-204.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:20,regY:-204,x:20,y:-213},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:20,regY:-204,x:20,y:-216.95},0).wait(1).to({y:-213.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:20,regY:-204,x:20,y:-202},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:20,regY:-204,x:20,y:-204.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:20,regY:-204,x:20,y:-203.4},0).wait(1).to({y:-201},0).wait(1).to({y:-198.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:20,regY:-204,x:20,y:-198.65},0).wait(1).to({y:-201},0).wait(1).to({y:-203.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:20,regY:-204,x:20,y:-203.85},0).wait(1).to({y:-203.3},0).wait(1).to({y:-202.2},0).wait(1).to({y:-200.85},0).wait(1).to({y:-199.75},0).wait(1).to({y:-199.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:20,regY:-204,x:20,y:-199.2},0).wait(1).to({y:-199.75},0).wait(1).to({y:-200.85},0).wait(1).to({y:-202.2},0).wait(1).to({y:-203.3},0).wait(1).to({y:-203.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:20,regY:-204,x:20,y:-199.25},0).wait(1).to({y:-202.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:20,regY:-204,x:20,y:-201.8},0).wait(1).to({y:-203.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:20,regY:-204,rotation:-0.0253,x:19.9,y:-203.95},0).wait(1).to({rotation:-0.1129,x:19.7,y:-203.7},0).wait(1).to({rotation:-0.2845,x:19.35,y:-203.2},0).wait(1).to({rotation:-0.5565,x:18.7,y:-202.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:17.95,y:-201.4},0).wait(1).to({rotation:-1.2075,x:17.25,y:-200.5},0).wait(1).to({rotation:-1.4141,x:16.75,y:-199.85},0).wait(1).to({rotation:-1.5201,x:16.55,y:-199.55},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:20,regY:-204,rotation:-1.5305,x:16.5,y:-199.55},0).wait(1).to({rotation:-1.4624,x:16.65,y:-199.7},0).wait(1).to({rotation:-1.3309,x:16.95,y:-200.1},0).wait(1).to({rotation:-1.121,x:17.4,y:-200.8},0).wait(1).to({rotation:-0.8372,x:18.05,y:-201.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:18.75,y:-202.55},0).wait(1).to({rotation:-0.2881,x:19.3,y:-203.25},0).wait(1).to({rotation:-0.1291,x:19.65,y:-203.75},0).wait(1).to({rotation:-0.0467,x:19.85,y:-203.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:20,regY:-204,rotation:-0.0253,x:19.9,y:-203.95},0).wait(1).to({rotation:-0.1129,x:19.7,y:-203.7},0).wait(1).to({rotation:-0.2845,x:19.35,y:-203.2},0).wait(1).to({rotation:-0.5565,x:18.7,y:-202.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:17.95,y:-201.4},0).wait(1).to({rotation:-1.2075,x:17.25,y:-200.5},0).wait(1).to({rotation:-1.4141,x:16.75,y:-199.85},0).wait(1).to({rotation:-1.5201,x:16.55,y:-199.55},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:20,regY:-204,rotation:-1.5302,x:16.5,y:-199.55},0).wait(1).to({rotation:-1.461,x:16.65,y:-199.7},0).wait(1).to({rotation:-1.3276,x:16.95,y:-200.1},0).wait(1).to({rotation:-1.1146,x:17.45,y:-200.8},0).wait(1).to({rotation:-0.8266,x:18.1,y:-201.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:18.8,y:-202.55},0).wait(1).to({rotation:-0.2693,x:19.35,y:-203.25},0).wait(1).to({rotation:-0.1079,x:19.7,y:-203.75},0).wait(1).to({rotation:-0.0243,x:19.9,y:-203.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:20,regY:-204,x:20,y:-209.55},0).wait(1).to({y:-211.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:20,regY:-204,x:20,y:-211.35},0).wait(1).to({y:-209.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:20,regY:-204,x:20,y:-212.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:20,regY:-204,x:20,y:-213.2},0).wait(1).to({y:-210.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:20,regY:-204,rotation:-0.0253,x:19.9,y:-203.9},0).wait(1).to({rotation:-0.1129,x:19.7,y:-203.4},0).wait(1).to({rotation:-0.2845,x:19.35,y:-202.45},0).wait(1).to({rotation:-0.5565,x:18.7,y:-201},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:17.95,y:-199.05},0).wait(1).to({rotation:-1.2075,x:17.25,y:-197.35},0).wait(1).to({rotation:-1.4141,x:16.75,y:-196.2},0).wait(1).to({rotation:-1.5201,x:16.55,y:-195.65},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:20,regY:-204,rotation:-1.5305,x:16.5,y:-195.6},0).wait(1).to({rotation:-1.4624,x:16.65,y:-195.95},0).wait(1).to({rotation:-1.3309,x:16.95,y:-196.65},0).wait(1).to({rotation:-1.121,x:17.4,y:-197.9},0).wait(1).to({rotation:-0.8372,x:18.05,y:-199.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:18.75,y:-201.2},0).wait(1).to({rotation:-0.2881,x:19.3,y:-202.55},0).wait(1).to({rotation:-0.1291,x:19.65,y:-203.45},0).wait(1).to({rotation:-0.0467,x:19.85,y:-203.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:20,regY:-204,rotation:-0.147,x:19.65,y:-203.6},0).wait(1).to({rotation:-0.7239,x:18.35,y:-201.9},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:16.85,y:-200},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:20,regY:-204,rotation:-1.4913,x:16.6,y:-199.6},0).wait(1).to({rotation:-1.2701,x:17.1,y:-200.35},0).wait(1).to({rotation:-0.8372,x:18.05,y:-201.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:19.1,y:-203.05},0).wait(1).to({rotation:-0.094,x:19.7,y:-203.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:20,regY:-204,rotation:-0.0894,x:19.8,y:-203.8},0).wait(1).to({rotation:-0.4358,x:19,y:-202.75},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:17.65,y:-201},0).wait(1).to({rotation:-1.4426,x:16.7,y:-199.75},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:20,regY:-204,rotation:-1.4913,x:16.6,y:-199.6},0).wait(1).to({rotation:-1.2701,x:17.1,y:-200.35},0).wait(1).to({rotation:-0.8372,x:18.05,y:-201.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:19.1,y:-203.05},0).wait(1).to({rotation:-0.094,x:19.7,y:-203.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:20,regY:-204,x:20,y:-212.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:20,regY:-204,x:20,y:-213.2},0).wait(1).to({y:-210.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:20,regY:-204,x:17.25,y:-196.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:20,regY:-204,x:20,y:-191.75},0).wait(1).to({y:-194.7},0).wait(1).to({y:-199.65},0).wait(1).to({y:-203.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:20,regY:-204,x:20,y:-203},0).wait(1).to({y:-197.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:20,regY:-204,x:20,y:-196.2},0).wait(1).to({y:-200.5},0).wait(1).to({y:-204.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:20,regY:-204,x:20,y:-204.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:20,regY:-204,x:20,y:-210.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:20,regY:-204,x:20,y:-210.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:20,regY:-204,x:20,y:-212.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:20,regY:-204,x:20,y:-213.2},0).wait(1).to({y:-210.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:20,regY:-204,x:17.25,y:-196.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:20,regY:-204,x:20,y:-193.25},0).wait(1).to({y:-201},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:20,regY:-204,x:20,y:-205},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:20,regY:-204,x:20,y:-204.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:20,regY:-204,x:20,y:-203.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:20,regY:-204,x:20,y:-203.4},0).wait(1).to({y:-201},0).wait(1).to({y:-198.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:20,regY:-204,x:20,y:-198.6},0).wait(1).to({y:-198.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:20,regY:-204,x:20,y:-199.4},0).wait(1).to({y:-200.9},0).wait(1).to({y:-203.15},0).wait(1).to({y:-204.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:20,regY:-204,x:20,y:-204.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:20,regY:-204,x:20,y:-211.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:20,regY:-204,x:20,y:-213.2},0).wait(1).to({y:-210.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:20,regY:-204,x:20,y:-211.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:20,regY:-204,x:20,y:-212},0).wait(1).to({y:-206},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:20,regY:-204,x:20,y:-199.35},0).wait(1).to({y:-200.55},0).wait(1).to({y:-202.5},0).wait(1).to({y:-203.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:20,regY:-204,x:20,y:-208.95},0).wait(1).to({y:-203.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:20,regY:-204,x:20,y:-208.95},0).wait(1).to({y:-203.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:20,regY:-204,x:20,y:-203.1},0).wait(1).to({y:-203.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:20,regY:-204,x:23,y:-200.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:20,regY:-204,x:19.15,y:-194.55},0).wait(1).to({x:19.8,y:-194.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:20,regY:-204,x:20,y:-194.7},0).wait(1).to({y:-197.15},0).wait(1).to({y:-200.85},0).wait(1).to({y:-203.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:20,regY:-204,rotation:-0.0185,x:19.95,y:-203.95},0).wait(1).to({rotation:-0.0825,x:19.7,y:-203.75},0).wait(1).to({rotation:-0.2079,x:19.25,y:-203.3},0).wait(1).to({rotation:-0.4067,x:18.55,y:-202.7},0).wait(1).to({rotation:-0.6563,x:17.65,y:-201.85},0).wait(1).to({rotation:-0.8825,x:16.85,y:-201.1},0).wait(1).to({rotation:-1.0334,x:16.3,y:-200.55},0).wait(1).to({rotation:-1.111,x:16.05,y:-200.3},0).wait(1).to({regX:0,regY:0,rotation:-1.1331,x:0,y:4.1},0).wait(1).to({regX:20,regY:-204,rotation:-1.1186,x:16,y:-200.35},0).wait(1).to({rotation:-1.0691,x:16.2,y:-200.45},0).wait(1).to({rotation:-0.9735,x:16.55,y:-200.8},0).wait(1).to({rotation:-0.821,x:17.1,y:-201.4},0).wait(1).to({rotation:-0.6147,x:17.8,y:-202.05},0).wait(1).to({rotation:-0.3943,x:18.6,y:-202.85},0).wait(1).to({rotation:-0.2156,x:19.25,y:-203.45},0).wait(1).to({rotation:-0.1,x:19.65,y:-203.85},0).wait(1).to({rotation:-0.0401,x:19.85,y:-204},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,880.5999999999999,841.0999999999999);
...
// stage content:
(lib._446_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:199,scene2:200,end2:372,scene3:373,end3:560,scene4:561,end4:710,scene5:711,end5:880,scene6:881,end6:1047,scene7:1048,end7:1201});
	...
	this.frame_303 = function() {
		exportRoot._g.m3 = "じっと見つめられると……";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 2);
		this.ch2.gotoAndStop("swing_on");
	}
	this.frame_342 = function() {
		exportRoot._g.m3 = this.m.t[exportRoot._g.idx][3];
		exportRoot._g.m4 = this.m.t[exportRoot._g.idx][4];
	...
	this.frame_918 = function() {
		exportRoot._g.m2 = "ﾌﾟﾛﾃﾞｭｰｻｰには､";
		exportRoot._u.setText();
	}
	this.frame_944 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "ほしいな……";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 7);
	}
	this.frame_975 = function() {
		this.ch2.gotoAndStop("swing");
	}
	this.frame_978 = function() {
		exportRoot._g.m3 = "ほしいな……なんて｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 3);
	}
	...
	this.frame_1064 = function() {
		exportRoot._g.m1 = "そうだ! ﾌﾟﾛﾃﾞｭｰｻｰの､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 4);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(29).call(this.frame_44).wait(24).call(this.frame_68).wait(17).call(this.frame_85).wait(35).call(this.frame_120).wait(17).call(this.frame_137).wait(10).call(this.frame_147).wait(11).call(this.frame_158).wait(12).call(this.frame_170).wait(19).call(this.frame_189).wait(3).call(this.frame_192).wait(7).call(this.frame_199).wait(1).call(this.frame_200).wait(20).call(this.frame_220).wait(50).call(this.frame_270).wait(33).call(this.frame_303).wait(39).call(this.frame_342).wait(16).call(this.frame_358).wait(14).call(this.frame_372).wait(1).call(this.frame_373).wait(24).call(this.frame_397).wait(30).call(this.frame_427).wait(18).call(this.frame_445).wait(27).call(this.frame_472).wait(54).call(this.frame_526).wait(34).call(this.frame_560).wait(1).call(this.frame_561).wait(28).call(this.frame_589).wait(40).call(this.frame_629).wait(12).call(this.frame_641).wait(19).call(this.frame_660).wait(35).call(this.frame_695).wait(15).call(this.frame_710).wait(1).call(this.frame_711).wait(3).call(this.frame_714).wait(34).call(this.frame_748).wait(17).call(this.frame_765).wait(42).call(this.frame_807).wait(22).call(this.frame_829).wait(15).call(this.frame_844).wait(31).call(this.frame_875).wait(5).call(this.frame_880).wait(1).call(this.frame_881).wait(22).call(this.frame_903).wait(15).call(this.frame_918).wait(26).call(this.frame_944).wait(31).call(this.frame_975).wait(3).call(this.frame_978).wait(21).call(this.frame_999).wait(15).call(this.frame_1014).wait(33).call(this.frame_1047).wait(1).call(this.frame_1048).wait(16).call(this.frame_1064).wait(18).call(this.frame_1082).wait(25).call(this.frame_1107).wait(26).call(this.frame_1133).wait(15).call(this.frame_1148).wait(25).call(this.frame_1173).wait(28).call(this.frame_1201).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1206));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1201).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1206));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1187));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1191));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({alpha:0.1016},3).to({_off:true},1).wait(1187));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1093).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1133).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1133).to({_off:false},0).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(1133).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1133).to({_off:false},0).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1121).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(711).to({_off:false},0).to({alpha:1},3).to({alpha:0},6).to({_off:true},1).wait(327).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(150));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1191));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:-3.2},0).wait(1).to({y:-6.85},0).wait(1).to({y:-12.75},0).wait(1).to({y:-20.7},0).wait(1).to({y:-30.4},0).wait(1).to({y:-41.5},0).wait(1).to({y:-53.55},0).wait(1).to({y:-65.9},0).wait(1).to({y:-78.05},0).wait(1).to({y:-89.25},0).wait(1).to({y:-98.95},0).wait(1).to({y:-106.45},0).wait(1).to({y:-111.3},0).wait(1).to({regX:0,x:120,y:-113},0).wait(13).to({regX:1,x:121,y:-110.95},0).wait(1).to({y:-109.55},0).wait(1).to({regX:0,x:120,y:-109},0).wait(1).to({regX:1,x:121,y:-109.6,alpha:0.9932},0).wait(1).to({y:-111.4,alpha:0.9733},0).wait(1).to({y:-114.3,alpha:0.941},0).wait(1).to({y:-118.25,alpha:0.8976},0).wait(1).to({y:-123.05,alpha:0.8447},0).wait(1).to({y:-128.55,alpha:0.7842},0).wait(1).to({y:-134.5,alpha:0.7183},0).wait(1).to({y:-140.8,alpha:0.6491},0).wait(1).to({y:-147.15,alpha:0.5787},0).wait(1).to({y:-153.5,alpha:0.5087},0).wait(1).to({y:-159.7,alpha:0.4407},0).wait(1).to({y:-165.55,alpha:0.3758},0).wait(1).to({y:-171.05,alpha:0.3152},0).wait(1).to({y:-176.1,alpha:0.2593},0).wait(1).to({y:-180.7,alpha:0.2086},0).wait(1).to({y:-184.8,alpha:0.1635},0).wait(1).to({y:-188.4,alpha:0.1239},0).wait(1).to({y:-191.45,alpha:0.0901},0).wait(1).to({y:-194,alpha:0.0618},0).wait(1).to({y:-196.1,alpha:0.0391},0).wait(1).to({y:-197.65,alpha:0.0217},0).wait(1).to({y:-198.75,alpha:0.0095},0).wait(1).to({y:-199.4,alpha:0.0023},0).wait(1).to({regX:0,x:120,y:-199.65,alpha:0},0).to({_off:true},168).wait(645).to({_off:false,alpha:1},0).wait(1).to({regX:1,x:121,y:-199.4},0).wait(1).to({y:-198.7},0).wait(1).to({y:-197.55},0).wait(1).to({y:-196.05},0).wait(1).to({y:-194.2},0).wait(1).to({y:-192.05},0).wait(1).to({y:-189.7},0).wait(1).to({y:-187.15},0).wait(1).to({y:-184.45},0).wait(1).to({y:-181.7},0).wait(1).to({y:-178.9},0).wait(1).to({y:-176.1},0).wait(1).to({y:-173.3},0).wait(1).to({y:-170.5},0).wait(1).to({y:-167.75},0).wait(1).to({y:-165.05},0).wait(1).to({y:-162.45},0).wait(1).to({y:-159.85},0).wait(1).to({y:-157.4},0).wait(1).to({y:-155},0).wait(1).to({y:-152.65},0).wait(1).to({y:-150.4},0).wait(1).to({y:-148.25},0).wait(1).to({y:-146.2},0).wait(1).to({y:-144.2},0).wait(1).to({y:-142.25},0).wait(1).to({y:-140.45},0).wait(1).to({y:-138.65},0).wait(1).to({y:-137},0).wait(1).to({y:-135.35},0).wait(1).to({y:-133.8},0).wait(1).to({y:-132.35},0).wait(1).to({y:-130.95},0).wait(1).to({y:-129.6},0).wait(1).to({y:-128.35},0).wait(1).to({y:-127.1},0).wait(1).to({y:-125.95},0).wait(1).to({y:-124.9},0).wait(1).to({y:-123.85},0).wait(1).to({y:-122.85},0).wait(1).to({y:-121.95},0).wait(1).to({y:-121.1},0).wait(1).to({y:-120.25},0).wait(1).to({y:-119.5},0).wait(1).to({y:-118.8},0).wait(1).to({y:-118.1},0).wait(1).to({y:-117.5},0).wait(1).to({y:-116.9},0).wait(1).to({y:-116.35},0).wait(1).to({y:-115.9},0).wait(1).to({y:-115.45},0).wait(1).to({y:-115},0).wait(1).to({y:-114.65},0).wait(1).to({y:-114.3},0).wait(1).to({y:-114.05},0).wait(1).to({y:-113.8},0).wait(1).to({y:-113.55},0).wait(1).to({y:-113.4},0).wait(1).to({y:-113.25},0).wait(1).to({y:-113.1},0).wait(1).to({y:-113.05},0).wait(1).to({y:-113},0).wait(1).to({regX:0,x:120},0).to({_off:true},104).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:308.45},0).wait(1).to({y:309.8},0).wait(1).to({y:312.05},0).wait(1).to({y:315.05},0).wait(1).to({y:318.75},0).wait(1).to({y:322.95},0).wait(1).to({y:327.5},0).wait(1).to({y:332.15},0).wait(1).to({y:336.75},0).wait(1).to({y:341},0).wait(1).to({y:344.65},0).wait(1).to({y:347.5},0).wait(1).to({y:349.35},0).wait(1).to({regX:0,x:120,y:350},0).wait(13).to({regX:1,x:121,y:347.95},0).wait(1).to({y:346.55},0).wait(1).to({regX:0,x:120,y:346},0).wait(1).to({regX:1,x:121,y:347.05,alpha:0.9932},0).wait(1).to({y:350.3,alpha:0.9733},0).wait(1).to({y:355.55,alpha:0.941},0).wait(1).to({y:362.55,alpha:0.8976},0).wait(1).to({y:371.15,alpha:0.8447},0).wait(1).to({y:380.95,alpha:0.7842},0).wait(1).to({y:391.6,alpha:0.7183},0).wait(1).to({y:402.8,alpha:0.6491},0).wait(1).to({y:414.25,alpha:0.5787},0).wait(1).to({y:425.55,alpha:0.5087},0).wait(1).to({y:436.6,alpha:0.4407},0).wait(1).to({y:447.1,alpha:0.3758},0).wait(1).to({y:456.9,alpha:0.3152},0).wait(1).to({y:465.95,alpha:0.2593},0).wait(1).to({y:474.2,alpha:0.2086},0).wait(1).to({y:481.5,alpha:0.1635},0).wait(1).to({y:487.9,alpha:0.1239},0).wait(1).to({y:493.4,alpha:0.0901},0).wait(1).to({y:497.95,alpha:0.0618},0).wait(1).to({y:501.65,alpha:0.0391},0).wait(1).to({y:504.45,alpha:0.0217},0).wait(1).to({y:506.45,alpha:0.0095},0).wait(1).to({y:507.6,alpha:0.0023},0).wait(1).to({regX:0,x:120,y:508,alpha:0},0).to({_off:true},168).wait(645).to({_off:false,alpha:1},0).wait(1).to({regX:1,x:121,y:507.55},0).wait(1).to({y:506.25},0).wait(1).to({y:504.2},0).wait(1).to({y:501.45},0).wait(1).to({y:498.05},0).wait(1).to({y:494.15},0).wait(1).to({y:489.85},0).wait(1).to({y:485.2},0).wait(1).to({y:480.35},0).wait(1).to({y:475.3},0).wait(1).to({y:470.2},0).wait(1).to({y:465.05},0).wait(1).to({y:459.95},0).wait(1).to({y:454.85},0).wait(1).to({y:449.85},0).wait(1).to({y:444.95},0).wait(1).to({y:440.15},0).wait(1).to({y:435.5},0).wait(1).to({y:430.95},0).wait(1).to({y:426.6},0).wait(1).to({y:422.35},0).wait(1).to({y:418.25},0).wait(1).to({y:414.3},0).wait(1).to({y:410.55},0).wait(1).to({y:406.9},0).wait(1).to({y:403.4},0).wait(1).to({y:400.05},0).wait(1).to({y:396.8},0).wait(1).to({y:393.75},0).wait(1).to({y:390.8},0).wait(1).to({y:388},0).wait(1).to({y:385.3},0).wait(1).to({y:382.75},0).wait(1).to({y:380.3},0).wait(1).to({y:378},0).wait(1).to({y:375.75},0).wait(1).to({y:373.7},0).wait(1).to({y:371.7},0).wait(1).to({y:369.8},0).wait(1).to({y:368},0).wait(1).to({y:366.35},0).wait(1).to({y:364.75},0).wait(1).to({y:363.25},0).wait(1).to({y:361.85},0).wait(1).to({y:360.55},0).wait(1).to({y:359.35},0).wait(1).to({y:358.2},0).wait(1).to({y:357.15},0).wait(1).to({y:356.15},0).wait(1).to({y:355.25},0).wait(1).to({y:354.45},0).wait(1).to({y:353.7},0).wait(1).to({y:353.05},0).wait(1).to({y:352.45},0).wait(1).to({y:351.9},0).wait(1).to({y:351.45},0).wait(1).to({y:351.05},0).wait(1).to({y:350.7},0).wait(1).to({y:350.45},0).wait(1).to({y:350.25},0).wait(1).to({y:350.1},0).wait(1).to({y:350},0).wait(1).to({regX:0,x:120},0).to({_off:true},104).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(881).to({_off:false},0).to({alpha:1},35).to({_off:true},132).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(881).to({_off:false},0).to({alpha:0.4492},35).to({_off:true},132).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).wait(1092).to({_off:true},26).wait(73));

	// ef
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-868,-149.85,1.27,1.27);

	this.bg1_1 = new lib.ef();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-113.05,-149.05,0.936,0.936,0,0,0,-0.1,0);
	this.bg1_1.compositeOperation = "lighter";
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.bg1}]}).to({state:[{t:this.bg1_1}]},15).to({state:[{t:this.bg1_1}]},26).to({state:[{t:this.bg1_1}]},3).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},90).to({state:[{t:this.bg1_1}]},26).to({state:[{t:this.bg1_1}]},16).to({state:[{t:this.bg1_1}]},19).to({state:[]},1).wait(986));
	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(15).to({_off:false},0).to({x:-123.05,y:-149.7},26,cjs.Ease.none).wait(4).to({regX:230,regY:360,scaleX:0.9294,scaleY:0.9294,x:93.05,y:186.25},0).wait(1).to({scaleX:0.9189,scaleY:0.9189,x:94.15,y:184.55},0).wait(1).to({scaleX:0.9048,scaleY:0.9048,x:95.65,y:182.3},0).wait(1).to({scaleX:0.8876,scaleY:0.8876,x:97.45,y:179.55},0).wait(1).to({scaleX:0.868,scaleY:0.868,x:99.5,y:176.4},0).wait(1).to({scaleX:0.8467,scaleY:0.8467,x:101.75,y:173},0).wait(1).to({scaleX:0.8246,scaleY:0.8246,x:104.05,y:169.5},0).wait(1).to({scaleX:0.8023,scaleY:0.8023,x:106.4,y:165.95},0).wait(1).to({scaleX:0.7806,scaleY:0.7806,x:108.7,y:162.5},0).wait(1).to({scaleX:0.7599,scaleY:0.7599,x:110.85,y:159.2},0).wait(1).to({scaleX:0.7406,scaleY:0.7406,x:112.9,y:156.05},0).wait(1).to({scaleX:0.7228,scaleY:0.7228,x:114.75,y:153.25},0).wait(1).to({scaleX:0.7066,scaleY:0.7066,x:116.45,y:150.65},0).wait(1).to({scaleX:0.6921,scaleY:0.6921,x:118,y:148.35},0).wait(1).to({scaleX:0.6793,scaleY:0.6793,x:119.35,y:146.3},0).wait(1).to({scaleX:0.6681,scaleY:0.6681,x:120.5,y:144.5},0).wait(1).to({scaleX:0.6585,scaleY:0.6585,x:121.5,y:142.95},0).wait(1).to({scaleX:0.6505,scaleY:0.6505,x:122.35,y:141.65},0).wait(1).to({scaleX:0.6439,scaleY:0.6439,x:123.05,y:140.65},0).wait(1).to({scaleX:0.6386,scaleY:0.6386,x:123.6,y:139.8},0).wait(1).to({scaleX:0.6346,scaleY:0.6346,x:124,y:139.15},0).wait(1).to({scaleX:0.6319,scaleY:0.6319,x:124.3,y:138.75},0).wait(1).to({scaleX:0.6303,scaleY:0.6303,x:124.45,y:138.45},0).wait(1).to({regX:-0.3,regY:0,scaleX:0.6298,scaleY:0.6298,x:-20.45,y:-88.35},0).wait(90).to({scaleX:0.6812,scaleY:0.6812,x:-32.25,y:-106.8},26,cjs.Ease.quadInOut).wait(16).to({alpha:0},19).to({_off:true},1).wait(986));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-601.45,553.9,1.27,1.27,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.1,scaleX:0.936,scaleY:0.936,x:83.7,y:378.3},0).to({x:73.7},26,cjs.Ease.none).wait(4).to({regX:-49.2,regY:-260.8,scaleX:0.9294,scaleY:0.9294,x:28.65,y:133.35},0).wait(1).to({scaleX:0.9189,scaleY:0.9189,x:30.5,y:132.3},0).wait(1).to({scaleX:0.9048,scaleY:0.9048,x:33,y:130.9},0).wait(1).to({scaleX:0.8876,scaleY:0.8876,x:36,y:129.05},0).wait(1).to({scaleX:0.868,scaleY:0.868,x:39.4,y:127.1},0).wait(1).to({scaleX:0.8467,scaleY:0.8467,x:43.1,y:124.9},0).wait(1).to({scaleX:0.8246,scaleY:0.8246,x:47,y:122.6},0).wait(1).to({scaleX:0.8023,scaleY:0.8023,x:50.9,y:120.3},0).wait(1).to({scaleX:0.7806,scaleY:0.7806,x:54.65,y:118.05},0).wait(1).to({scaleX:0.7599,scaleY:0.7599,x:58.25,y:115.95},0).wait(1).to({scaleX:0.7406,scaleY:0.7406,x:61.65,y:113.95},0).wait(1).to({scaleX:0.7228,scaleY:0.7228,x:64.75,y:112.1},0).wait(1).to({scaleX:0.7066,scaleY:0.7066,x:67.6,y:110.5},0).wait(1).to({scaleX:0.6921,scaleY:0.6921,x:70.1,y:108.95},0).wait(1).to({scaleX:0.6793,scaleY:0.6793,x:72.35,y:107.65},0).wait(1).to({scaleX:0.6681,scaleY:0.6681,x:74.3,y:106.5},0).wait(1).to({scaleX:0.6585,scaleY:0.6585,x:75.95,y:105.5},0).wait(1).to({scaleX:0.6505,scaleY:0.6505,x:77.4,y:104.7},0).wait(1).to({scaleX:0.6439,scaleY:0.6439,x:78.5,y:104},0).wait(1).to({scaleX:0.6386,scaleY:0.6386,x:79.45,y:103.45},0).wait(1).to({scaleX:0.6346,scaleY:0.6346,x:80.15,y:103.05},0).wait(1).to({scaleX:0.6319,scaleY:0.6319,x:80.6,y:102.75},0).wait(1).to({scaleX:0.6303,scaleY:0.6303,x:80.9,y:102.6},0).wait(1).to({regX:0.1,regY:0.1,scaleX:0.6298,scaleY:0.6298,x:112.05,y:266.9},0).wait(90).to({scaleX:0.6812,scaleY:0.6812,x:111,y:277.4},26,cjs.Ease.quadInOut).wait(16).to({alpha:0},19).to({_off:true},1).wait(986));

	// bg
	this.bg1_2 = new lib.bg_zoom_half();
	this.bg1_2.name = "bg1_2";
	this.bg1_2.parent = this;
	this.bg1_2.setTransform(-868,-149.85,1.27,1.27);

	this.timeline.addTween(cjs.Tween.get(this.bg1_2).wait(15).to({regX:-0.1,scaleX:0.936,scaleY:0.936,x:-113.05,y:-140.35},0).to({x:-123.05},26,cjs.Ease.none).wait(4).to({regX:230,regY:350,scaleX:0.9294,scaleY:0.9294,x:93.05,y:186.25},0).wait(1).to({scaleX:0.9189,scaleY:0.9189,x:94.15,y:184.55},0).wait(1).to({scaleX:0.9048,scaleY:0.9048,x:95.65,y:182.3},0).wait(1).to({scaleX:0.8876,scaleY:0.8876,x:97.45,y:179.55},0).wait(1).to({scaleX:0.868,scaleY:0.868,x:99.5,y:176.45},0).wait(1).to({scaleX:0.8467,scaleY:0.8467,x:101.75,y:173.05},0).wait(1).to({scaleX:0.8246,scaleY:0.8246,x:104.05,y:169.5},0).wait(1).to({scaleX:0.8023,scaleY:0.8023,x:106.4,y:165.9},0).wait(1).to({scaleX:0.7806,scaleY:0.7806,x:108.7,y:162.45},0).wait(1).to({scaleX:0.7599,scaleY:0.7599,x:110.85,y:159.2},0).wait(1).to({scaleX:0.7406,scaleY:0.7406,x:112.9,y:156.1},0).wait(1).to({scaleX:0.7228,scaleY:0.7228,x:114.75,y:153.2},0).wait(1).to({scaleX:0.7066,scaleY:0.7066,x:116.45,y:150.65},0).wait(1).to({scaleX:0.6921,scaleY:0.6921,x:118,y:148.35},0).wait(1).to({scaleX:0.6793,scaleY:0.6793,x:119.35,y:146.3},0).wait(1).to({scaleX:0.6681,scaleY:0.6681,x:120.5,y:144.5},0).wait(1).to({scaleX:0.6585,scaleY:0.6585,x:121.5,y:143},0).wait(1).to({scaleX:0.6505,scaleY:0.6505,x:122.35,y:141.7},0).wait(1).to({scaleX:0.6439,scaleY:0.6439,x:123.05,y:140.65},0).wait(1).to({scaleX:0.6386,scaleY:0.6386,x:123.6,y:139.8},0).wait(1).to({scaleX:0.6346,scaleY:0.6346,x:124,y:139.15},0).wait(1).to({scaleX:0.6319,scaleY:0.6319,x:124.3,y:138.7},0).wait(1).to({scaleX:0.6303,scaleY:0.6303,x:124.45,y:138.5},0).wait(1).to({regX:-0.3,regY:0,scaleX:0.6298,scaleY:0.6298,x:-20.45,y:-82.05},0).wait(90).to({scaleX:0.6812,scaleY:0.6812,x:-32.25,y:-100},26,cjs.Ease.quadInOut).wait(16).to({alpha:0},19).to({_off:true},1).wait(986));

	// ef2
	this.bg1_3 = new lib.ef();
	this.bg1_3.name = "bg1_3";
	this.bg1_3.parent = this;
	this.bg1_3.setTransform(-17.75,-136.45,0.7223,0.7223,0,0,0,-0.4,-0.1);
	this.bg1_3.compositeOperation = "lighter";
	this.bg1_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_3).wait(200).to({_off:false},0).wait(70).to({x:-60.25,y:-102.85},72,cjs.Ease.quadInOut).wait(31).to({regY:-0.2,scaleX:0.8257,scaleY:0.8257,x:-84.55,y:-134.4},80,cjs.Ease.quadInOut).wait(261).to({regY:-0.1,scaleX:0.7007,scaleY:0.7007,x:-44,y:-96.85},0).wait(167).to({scaleX:1.1236,scaleY:1.1236,x:-167.4,y:-203.9},63,cjs.Ease.quadInOut).wait(104).to({regX:-0.3,regY:0,scaleX:0.6298,scaleY:0.6298,x:-20.45,y:-88.35},0).wait(59).to({_off:true},26).wait(73));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(134.2,271,0.7223,0.7223,0,0,0,0.1,0.1);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(200).to({_off:false},0).wait(70).to({x:91.8,y:304.65},72,cjs.Ease.quadInOut).wait(31).to({regX:0.2,regY:0.2,scaleX:0.8257,scaleY:0.8257,x:89.2,y:331.6},80,cjs.Ease.quadInOut).wait(261).to({regY:0.1,scaleX:0.7007,scaleY:0.7007,x:103.45,y:298.45},0).wait(167).to({scaleX:1.1236,scaleY:1.1236,x:69,y:430.05},63,cjs.Ease.quadInOut).wait(104).to({regX:0.1,scaleX:0.6298,scaleY:0.6298,x:112.05,y:266.9},0).wait(59).to({_off:true},26).wait(73));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(-17.75,-129.25,0.7223,0.7223,0,0,0,-0.4,-0.1);
	this.bg2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(200).to({_off:false},0).wait(70).to({x:-60.15,y:-95.45},72,cjs.Ease.quadInOut).wait(31).to({regY:-0.2,scaleX:0.8257,scaleY:0.8257,x:-84.55,y:-126.15},80,cjs.Ease.quadInOut).wait(261).to({regY:-0.1,scaleX:0.7007,scaleY:0.7007,x:-44,y:-89.85},0).wait(167).to({scaleX:1.1236,scaleY:1.1236,x:-167.4,y:-192.65},63,cjs.Ease.quadInOut).wait(104).to({regX:-0.3,regY:0,scaleX:0.6298,scaleY:0.6298,x:-20.45,y:-82.05},0).wait(59).to({_off:true},26).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).wait(1107).to({_off:true},14).wait(85));

	// btn
	this.stage_btn = new lib.button();
	this.stage_btn.name = "stage_btn";
	this.stage_btn.parent = this;
	this.stage_btn.setTransform(120.15,155.15,0.851,0.851,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.stage_btn).wait(1107).to({x:150.95,y:84.8},0).to({_off:true},26).wait(68).to({_off:false,regX:0,regY:0,scaleX:1,scaleY:1,x:120,y:155},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-748,-720,1368,1459.2);
// library properties:
lib.properties = {
	id: '_446_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg", id:"_446_2_bg"},
		{src:"images/ch_base.png", id:"_446_2_ch_base"},
		{src:"images/ch_face1.png", id:"_446_2_ch_face1"},
		{src:"images/ch_face2.png", id:"_446_2_ch_face2"},
		{src:"images/ch_face3.png", id:"_446_2_ch_face3"},
		{src:"images/ch_face4.png", id:"_446_2_ch_face4"},
		{src:"images/ch_face5.png", id:"_446_2_ch_face5"},
		{src:"images/ch_face6.png", id:"_446_2_ch_face6"},
		{src:"images/ch_face7.png", id:"_446_2_ch_face7"},
		{src:"images/ch_face8.png", id:"_446_2_ch_face8"},
		{src:"images/ef1.png", id:"_446_2_ef1"},
		{src:"images/ef2.png", id:"_446_2_ef2"},
		{src:"images/finish.jpg", id:"_446_2_finish"},
		{src:"images/finish_blur.jpg", id:"_446_2_finish_blur"},
		{src:"images/tie_fp.png", id:"_446_2_tie_fp"},
		{src:"images/tie_sp.png", id:"_446_2_tie_sp"}
	],
	preloads: []
};

...
(lib.reflect_mask_3542302 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.reflect_mask_3542302, new cjs.Rectangle(-150.5,-65.2,301.1,130.5), null);
...
(lib.reflect_container_cjs_3542302 = function(mode,startPosition,loop) {
...
(lib.reflect_wrapper_3542302 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// cjs
	this.reflect = new lib.reflect_container_cjs_3542302();
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_3542302, new cjs.Rectangle(0,-375.2,301.1,750.5), null);
...
(lib.sign_effect_3542302 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(93.25,572,0.5819,0.5819);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(7.1,651.85,0.8819,0.8819);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.parent = this;
	this.instance_2.setTransform(288.85,654.2,0.8819,0.8819);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(256.4,582.35,0.8819,0.8819);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(163.45,595.1,0.6391,0.6391);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(217.95,630.45,0.6105,0.6105);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(59.2,623.1,0.5819,0.5819);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.parent = this;
	this.instance_7.setTransform(288.85,551.9,0.8819,0.8819);

	this.instance_8 = new lib.glitter_wrapper();
	this.instance_8.parent = this;
	this.instance_8.setTransform(11.15,546.65,0.8819,0.8819);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// mask_idn
	this.reflect_mask = new lib.reflect_mask_3542302();
	...
	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_3542302();
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_3542302, new cjs.Rectangle(-42.3,162.1,380.6,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_3542302();
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(-42.3,0,682.3,978.2), null);


// stage content:
(lib._3542302_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(148,489.1,1,1,0,0,0,148,489.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(277.7,627.7,60.60000000000002,350.5);
// library properties:
lib.properties = {
	id: '_3542302_sign_effect',
	width: 640,
	height: 800,
	fps: 18,
	color: "#333333",
...
an.compositions['_3542302_sign_effect'] = {

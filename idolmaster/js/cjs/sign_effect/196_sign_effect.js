...
}).prototype = getMCSymbolPrototype(lib.reflect_mask, new cjs.Rectangle(-171,-73.7,342,147.5), null);
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper, new cjs.Rectangle(0,-426.2,342,852.4), null);
...
(lib.sign_effect = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(110.45,548.7,0.6599,0.6599);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(332.25,641.9);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(295.45,560.4);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(190.1,574.85,0.7247,0.7247);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(251.85,614.95,0.6923,0.6923);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(71.85,606.65,0.6599,0.6599);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.parent = this;
	this.instance_7.setTransform(332.25,525.9);

	this.instance_8 = new lib.glitter_wrapper();
	this.instance_8.parent = this;
	this.instance_8.setTransform(17.35,519.95);
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(172.9063,327.2512);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper();
	this.reflect_wrapper.name = "reflect_wrapper";
	this.reflect_wrapper.parent = this;
	this.reflect_wrapper.setTransform(3.85,580.7);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect, new cjs.Rectangle(-43.3,162.1,431.7,747.6999999999999), null);
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(-43.3,0,683.3,1006.9), null);


// stage content:
(lib._196_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(172.5,503.4,1,1,0,0,0,172.5,503.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(276.7,554.5,111.69999999999999,452.4);
// library properties:
lib.properties = {
	id: '_196_sign_effect',
	width: 640,
...
an.compositions['_196_sign_effect'] = {

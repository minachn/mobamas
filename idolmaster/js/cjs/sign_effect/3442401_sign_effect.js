...
(lib.reflect_mask_3442401 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.reflect_mask_3442401, new cjs.Rectangle(-150.5,-65.2,301.1,130.5), null);
...
(lib.reflect_wrapper_3442401 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_3442401, new cjs.Rectangle(0,-375.2,301.1,750.5), null);
...
(lib.sign_effect_3442401 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_3442401, new cjs.Rectangle(-41.8,162.1,380.6,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_3442401();
...
// stage content:
(lib._3442401_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
an.compositions['_3442401_sign_effect'] = {

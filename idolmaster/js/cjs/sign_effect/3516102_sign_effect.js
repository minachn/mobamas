...
(lib.reflect_mask_3516102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,204,255,0.502)").s().p("");
	this.shape.setTransform(0.0283,-0.0002);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask_3516102, new cjs.Rectangle(-153.2,-66.9,306.5,133.8), null);
...
(lib.reflect_container_cjs_3516102 = function(mode,startPosition,loop) {
...
(lib.reflect_wrapper_3516102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// cjs
	this.reflect = new lib.reflect_container_cjs_3516102();
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_3516102, new cjs.Rectangle(0,-382,306.6,764.1), null);
...
(lib.sign_effect_3516102 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(421.55,486.85,0.5956,0.5956);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(333.4,568.55,0.9025,0.9025);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.parent = this;
	this.instance_2.setTransform(621.75,570.95,0.9025,0.9025);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(588.55,497.45,0.9025,0.9025);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(493.45,510.45,0.654,0.654);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(549.15,546.65,0.6248,0.6248);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(386.7,539.15,0.5956,0.5956);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.parent = this;
	this.instance_7.setTransform(621.75,466.25,0.9025,0.9025);

	this.instance_8 = new lib.glitter_wrapper();
	this.instance_8.parent = this;
	this.instance_8.setTransform(337.55,460.9,0.9025,0.9025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// mask_idn
	this.reflect_mask = new lib.reflect_mask_3516102();
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(316.6223,291.445);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_3516102();
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_3516102, new cjs.Rectangle(32,162.1,640.4,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_3516102();
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(0,0,672.4,898.1), null);


// stage content:
(lib._3516102_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(336.2,449,1,1,0,0,0,336.2,449);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(602.8,534,69.60000000000002,364.1);
// library properties:
lib.properties = {
	id: '_3516102_sign_effect',
	width: 640,
	height: 800,
	fps: 18,
	color: "#333333",
...
an.compositions['_3516102_sign_effect'] = {
